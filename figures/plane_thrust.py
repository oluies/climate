...
ax.annotate("Table C.6's jumbo jet: 363 tonnes, frontal area 180 m², drag coefficient 0.03, air at 0.4 kg/m³. The one quantity his table\n"
            "does not print is the area of the sausage of air the wings throw downwards; it is set here to the value that puts the optimum\n"
            "at the 220 m/s his table gives.",
