...
for g, txt in [(1000, "bright sun"), (200, "bright but cloudy"), (100, "overcast")]:
    ...
    ax.annotate(txt, xy=(g, 498), xytext=(-5, 0), textcoords="offset points",
...
ax.legend(frameon=False, fontsize=9.5, loc="upper left", bbox_to_anchor=(0.03, 0.78))
ax.set_title("Module power against light intensity, at 25 °C",
             loc="left", fontsize=12.5, fontweight="bold", pad=12)
ax.annotate("Eighteen years and six percentage points of efficiency later the shape is unchanged: output is\n"
