...
ax.annotate("Modelled from PVGIS. The 2006 array averaged 12 kWh/d measured, 11.5 modelled;\n"
            "the same roof with 2026 modules gives 15.9 — 26 W/m² of panel against 20.\n"
            "December still delivers about a seventh of June, whatever the panel.",
            xy=(0.335, 0.955), xycoords="axes fraction", va="top", fontsize=9.5, color=MUTED)
