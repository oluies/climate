...
Table 28.3 has two lines for this and they come to £2bn. It has no line at all for distribution. MacKay was costing an inventory of power stations, and half the bill is the thing that joins them up — which is chapter 26's argument arriving as somebody's capital plan.
...
**Be careful with that saving, though.** It is not a discount on the whole €780–1035 billion: the levers are applied to a base of €500 to €625 billion, being the 30 to 40% of generation investment and 80 to 90% of grid investment the study judges open to optimisation. Against that base it is about two and a half per cent, and against the full investment need about one and a half. The specific measure is modest either way. The variable behind it is not, and the two should not be confused. One percentage point on €900 billion, recovered over thirty-five years, is around **€7 billion a year** — every year, from a single number in a term sheet.
