...
**Those are not the consumption figures given earlier in this chapter, and the difference is instructive.** The 5.9 tonnes for Sweden and 7.1 for the United Kingdom quoted above are carbon dioxide alone; 7.6 and 10 are every greenhouse gas expressed as CO<sub>2</sub>-equivalent. Nothing has been recounted — methane and nitrous oxide have been let inside the fence. That is one of the three controls on the explorer at the end of this section, and moving it is the quickest demonstration in the chapter that a number can change by a third without anybody being wrong.

So the same country is **−0.7 tonnes a person and 7.6 tonnes a person**, a year apart, out of the same national inventory work. Every number is correct. They are answers to different questions, and a country can be a positive emitter, a net absorber and a substantial importer of other people's emissions all at once without any contradiction at all. What the boundary is drawn around decides which of those a reader is told about, and it is chosen before any measurement takes place.
