...
**HVO's real constraint is supply, and this is where the farm is the exception.** It comes from waste fats and vegetable oils, so it runs into chapter 6's land argument almost immediately — there is nowhere near enough of it to run a country's cars. But look at the size of the problem. **All of British farming's direct energy is 0.9 kWh per day per person**, against roughly 40 for driving. Traction is a fraction of that 0.9. A fuel with no prospect of covering road transport can comfortably cover ploughing, because ploughing is about one part in a hundred of the same demand. The tractor sits high on Liebreich's ladder not because it is uniquely hard to electrify but because it is small enough that the awkward answer is affordable.

**Where the electric machines are going, the world has split on how to refill them.** In China the answer is to change the battery rather than charge it. Swapping now accounts for about **a third of battery-electric heavy-truck sales**, CATL has standardised a swappable pack for heavy trucks, and its network exchanges a pack in around five minutes. In Europe and North America the answer is to charge harder: the Megawatt Charging System, standardised in 2026, is specified to **3.75 MW** — 3000 amps at 1250 volts — and aims at 80% in under half an hour. The two continents have chosen opposite solutions to the same problem, which is that a heavy vehicle's working day does not have a two-hour gap in it.[^swapcharge]

**Neither has reached the tractor, and the tractor's duty cycle is not the truck's either.** It is tempting to say a farm machine comes home every night and can charge slowly in its own yard. For most of the year that is true and it is the easy case. It is false in exactly the weeks that decide the question. When the weather window opens at harvest or for silage, machines work round the clock — night combining is ordinary practice, and in a hot summer it is preferred, because the crop takes up moisture after dark and comes in at a better condition. Contractors run shifts and change drivers, not machines. There is no overnight gap to charge in, because the night is when the work is happening.

**That is what settles it, and it is not really about energy density at all.** During the window, fuel goes to the machine: a bowser drives out to the field and the combine barely stops. Electricity cannot be delivered that way. You can run a cable to a field corner, or you can carry a charged battery out to the machine and take the flat one back — which is swapping, the thing China standardised for lorries and Europe and America did not. **The one agricultural argument that is genuinely strong is the argument for the pack the continent building megawatt cables has decided against.** Until someone builds it, the liquid keeps winning for a reason simpler than chemistry: a tank can be refilled anywhere by a vehicle that brings the energy with it, and for about a fortnight a year that is the only property that matters.
