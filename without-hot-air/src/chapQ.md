...
<span class="figurenumber">Figure Q.1.</span> *Added in the 2026 revision.* The report's two headline categories, computed from the 1202 vetted pathways of the AR6 Scenarios Database and divided by the United Nations' medium population projection, with the right-hand axis converting the tonnage to the fuel it would be at this book's own 250 g of CO<sub>2</sub> per kWh.[^ar6maths]
...
Two things are worth reading off it. The step from C3 to C1 — from two degrees to one and a half — costs about 12 kWh/d per person of burning, which is roughly what the average European spends on driving. And the bottom of the ladder is not a plan at all: C7 and C8 have emissions per person higher in 2050 than today, which is what "no new policy" looks like once population growth is taken out.[^ar6ladder]
...
<span class="figurenumber">Figure Q.2.</span> *Added in the 2026 revision.* What the pathways build, carrier by carrier, computed from the AR6 Scenarios Database. Grey is 2020, the coloured dot is the median pathway in 2050, and the pale bar is the range the pathways span.[^ar6mix2]

In the 1.5 °C category the median pathway multiplies solar by 32 and wind by 16 between 2020 and 2050, roughly doubles nuclear, grows hydro by about four-fifths and biomass by about the same, and cuts coal by 95%, oil by 62% and gas by 42%. In the 2 °C category the growth is smaller and slower: solar by 21, wind by 13, nuclear by four-fifths, with coal down 82%, oil 33% and gas 15%.

In the book's own units, the median 1.5 °C world of 2050 runs on about 43 kWh/d per person of primary energy — a third less than Britain uses today — of which solar supplies 8.5, wind 6.9, biomass 9.3, nuclear 1.6 and hydro 2.4.

So nuclear does grow in the median pathway, and it grows less than anything else on the list. That is not a judgement the report makes; it is what happens when a thousand modelling teams each pick a mix and the middle one is taken.
