...
What does stand out is how little the 2 °C pathways ask of demand. Fifteen per cent per person over thirty years is roughly what efficiency delivers on its own, and European buildings in those pathways are the clearest case: 27 kWh/d per person today, 26 in 2050, having done essentially nothing in three decades. The 2 °C route is very nearly all supply — clean up what generates the energy and leave the using of it alone. The 1.5 °C route cannot be done that way, and that, rather than any single ratio, is the difference between them.
