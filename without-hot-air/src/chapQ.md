...
![The IPCC's C1 and C3 pathways expressed as tonnes of CO2-equivalent per person per year, falling from 7.0 tonnes in 2019 to 0.93 for C1 and 2.07 for C3 by 2050, with the 5th-to-95th-percentile ranges shaded and a second axis giving the equivalent in kWh per day of fuel at 250 g of CO2 per kWh.](/img/without-hot-air/fig-q1-ar6-pathways.svg)

<span class="figurenumber">Figure Q.1.</span> *Added in the 2026 revision.* The report's two headline categories from Table SPM.2, divided by the United Nations' medium population projection, with the right-hand axis converting the tonnage to the fuel it would be at this book's own 250 g of CO<sub>2</sub> per kWh.[^ar6maths]

In 2019 the world emitted 7.0 tonnes per person. C1's median takes that to 3.6 tonnes by 2030 and 0.93 by 2050; C3's to 5.1 and 2.1.

Notice what the division does to the headline. The report's 84% cut by 2050 is a cut in the global total, and the population is projected to grow from 7.8 billion to 9.7 billion over the same period — so the cut each person has to make is 87%, not 84%. At 2030 the gap is wider in proportion: 43% globally, 49% each. Growth in the denominator is doing some of the work the report's percentages hide, and it is working against us.
...
Today's 7.0 tonnes per person is 77 kWh/d of burning — which is close to the 68.9 kWh/d of primary energy per person the world's richer half actually uses, and not far from MacKay's British stack of 125. C1's 2050 figure of 0.93 tonnes is 10 kWh/d. C3's 2.1 tonnes is 23.
...
Where the per-technology numbers do exist is underneath: every pathway in the report is published in the AR6 Scenarios Database, with primary energy by carrier for each one, and anyone who wants to know what a particular model did with nuclear can read it there. What cannot be done honestly is to quote a figure for "the IPCC's nuclear number", because the report does not have one.
...
[^ar6maths]: Figure Q.1 is this edition's arithmetic on the report's table. The medians and 5th-to-95th-percentile ranges are hand-entered from Table SPM.2 for categories C1 and C3, and the data task recomputes the report's own printed reduction percentages from them and fails if any drifts by more than 1.5 points — 44% against the printed 43% for C1 in 2030, and so on, the difference being rounding in the report. Population is the United Nations' medium projection as published by Our World in Data: 7.81 billion in 2019, 8.57 in 2030 and 9.66 in 2050. Three cautions. These are greenhouse gases, not carbon dioxide alone, so the conversion to kWh at 250 g per kWh describes what the tonnage would be if all of it were burnt fuel, which it is not — agriculture, cement and industrial gases are inside these totals, and the fuel share is the part this book's chapters can address. Dividing a global pathway by global population says nothing about who emits what: the report's own figures put the top 10% of households at 34 to 45% of consumption-based emissions. And a scenario is not a forecast; the ranges shown are the spread of models, not a probability that the world does any of this.
