...
In the book's own units, the median across the 1.5 °C pathways for total primary energy in 2050 is about 43 kWh/d per person — a third less than Britain uses today — with a median of 9.3 kWh/d for biomass, 8.5 for solar, 6.9 for wind, 2.4 for hydro and 1.6 for nuclear. Those are six separate medians over slightly different sets of pathways rather than one pathway's stack, which is why they do not add up to the total.
