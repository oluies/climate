...
C1 limits warming to 1.5 °C with no or limited overshoot: 97 pathways. C3 limits it to 2 °C with better than two chances in three: 311 pathways. Measured against modelled 2019 emissions of 55 GtCO<sub>2</sub>-equivalent, the median pathway in each category cuts global greenhouse gases by:
...
Global net zero CO<sub>2</sub> arrives in the early 2050s in C1 and around the early 2070s in C3. The cumulative carbon dioxide C1 spends on the way is 510 GtCO<sub>2</sub>, which at the 2019 rate is about thirteen years of it.

## The same pathways, divided by the people living on them

![The IPCC's C1 and C3 pathways expressed as tonnes of CO2-equivalent per person per year, falling from 7.0 tonnes in 2019 to 0.90 for C1 and 2.02 for C3 by 2050, with the 5th-to-95th-percentile ranges shaded and a second axis giving the equivalent in kWh per day of fuel at 250 g of CO2 per kWh.](/img/without-hot-air/fig-q1-ar6-pathways.svg)

<span class="figurenumber">Figure Q.1.</span> *This chapter and all its figures are new in the 2026 revision.* The report's two headline categories, computed from the 1202 vetted pathways of the AR6 Scenarios Database and divided by the United Nations' medium population projection, with the right-hand axis converting the tonnage to the fuel it would be at this book's own 250 g of CO<sub>2</sub> per kWh.[^ar6maths]
...
This book's carbon chart converts at 250 grams of CO<sub>2</sub> per kWh of chemical fuel, oil or petrol. Run the per-person emissions through it and the pathways turn into something a reader of chapter 2 can hold.
...
Half of the 2030 job is available cheaply. Options costing 100 dollars a tonne of CO<sub>2</sub>-equivalent or less could cut global emissions to half their 2019 level by 2030, and the largest contributions below 20 dollars come from solar, wind, efficiency, stopping the conversion of natural ecosystems, and methane from coal, oil, gas and waste.
...
| Category | Pathways | Cut by 2050 | Per person | As fuel | Net zero CO<sub>2</sub> | Peak warming |
|---|---|---|---|---|---|---|
...
![Two panels, one per category, showing each energy carrier's primary energy in 2020 and in 2050 on a logarithmic scale. In the 1.5 °C pathways solar grows 32-fold and wind 16-fold while coal falls 95%, oil 62% and gas 42%; nuclear roughly doubles and hydro and biomass grow by about 80 and 98%. The 5th-to-95th-percentile bars are wide: solar spans 31 to 200 EJ and nuclear 4 to 70.](/img/without-hot-air/fig-q2-ar6-energy-mix.svg)

<span class="figurenumber">Figure Q.2.</span> What the pathways build, carrier by carrier, computed from the AR6 Scenarios Database. Grey is 2020, the coloured dot is the median across the pathways in 2050, and the pale bar is the range they span.[^ar6mix2]
...
The nearest thing to a technology ranking the report does publish is a different quantity: the emissions each option could remove in 2030, and what that costs. Wind and solar are the two largest options in that chart, each around 4 GtCO<sub>2</sub>-equivalent a year, most of it available below 20 dollars a tonne; nuclear is on the same chart at well under a gigatonne, and at a higher cost. That is a statement about 2030 potential and price, not about what any scenario builds.[^ar6mix]
...
![Two panels. Left, the multiple each carrier is scaled by between 2020 and 2050 in the median 1.5 °C pathway, world against Europe: solar ×32 and wind ×16 for the world against ×9 and ×7 for Europe, coal down 95% and 98%, and nuclear ×2.1 for the world but down 58% for Europe. Right, all primary energy per person per day: the world falls from 55 to 43 kWh/d and Europe from 90 to 69.](/img/without-hot-air/fig-q3-ar6-europe.svg)

<span class="figurenumber">Figure Q.3.</span> The same 1.5 °C pathways, asked about Europe. Europe here is the database's own R10EUROPE — the continent without the former Soviet republics, 547 million people in 2020 — and each pathway is divided by the population it carries itself.[^ar6eu]
...
![Two panels. Left, final energy per person per day in Europe from 2020 to 2050: all of it falls from 71 to 50 kWh/d in the 1.5 °C pathways but only to 60 in the 2 °C ones, while the electricity in it rises from 15 to 29; transport falls from 22 to 14, buildings from 26 to 19, industry from 22 to 17. Right, the average gigawatts a year the 1.5 °C median implies — 31 then 35 for wind, 61 then 38 for solar — against 19 GW of wind and 65 GW of solar actually built in 2025.](/img/without-hot-air/fig-q4-ar6-europe-change.svg)

<span class="figurenumber">Figure Q.4.</span> What the 1.5 °C and 2 °C pathways ask of a European, and of Europe. Left is demand, right is the rate of building rather than the stock.[^ar6eu2]
...
Now compare the two categories, because this is the part the report's own summary says only in words. Final energy per European falls 27% by 2050 in the 1.5 °C pathways and 9% in the 2 °C ones. The wind capacity the two build differs by 18%, and the solar capacity by 28%. The pathways are three times further apart in how much energy is used than in the machinery that supplies it. European buildings in the 2 °C pathways are the clearest case: they use 26 kWh/d per person today and 26 in 2050, having done essentially nothing. What separates one and a half degrees from two, in Europe, is mostly demand.
...
There is a trap in the first line of figure Q.3, and it is worth spending a paragraph on because almost every published summary of these pathways falls into it. Europe's *primary* energy falls 19% by 2050. Its *final* energy — what actually reaches a building, a factory or a wheel — falls 27%. Primary energy is the larger number and the smaller fall, and neither of them is mostly a story about Europeans doing less.

Three things are going on, and they do not have equal weight.

**The chimneys close.** A coal or gas station converts perhaps 40% of the fuel it burns into electricity and throws the rest away as heat. Wind and solar have no such step, and the report's accounting counts a kilowatt-hour of their output as a kilowatt-hour of primary energy. So Europe doubles its electricity generation, from 13.1 to 27.3 exajoules, while the primary energy behind that electricity goes *down*. Replace a coal station with a wind farm delivering exactly the same electricity to exactly the same customers and the primary-energy figure falls by about 60% with nothing whatever changing for anyone. This is the largest single term, and a good part of it is an accounting convention rather than a physical saving.
