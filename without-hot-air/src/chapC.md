...
**This is the chapter with the best predictive record in the book, and it is worth being clear about why.** Almost every other number here has moved by factors: solar down tenfold, nuclear up tenfold, batteries down 93%. Those are all *manufactured* things, whose cost falls when you make more of them and whose performance improves when a new material arrives. The lift-and-drag equation is not a manufactured thing, and no production volume lowers the floor it sets.
