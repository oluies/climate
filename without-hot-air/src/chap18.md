...
<span id="fig7"></span>![](/img/without-hot-air/figure130.gif)
...
![](/img/without-hot-air/figure132.gif)
...
![British low-carbon electricity per person in 2006 and 2025, stacked: nuclear falls from 3.40 to 1.44 kWh/d while wind rises from 0.19 to 3.49 and solar from nothing to 0.80, taking the total from 4.18 to 7.55.](/img/without-hot-air/fig-uk-low-carbon.svg)

<span class="figurenumber">Figure 18.9b.</span> The same picture in 2025. *Added in the 2026 revision.* MacKay had to scale the renewable half of figure 18.9 a hundredfold to make it visible. It no longer needs scaling — but nuclear more than halved over the same period, so the low-carbon total rose by less than the renewable part alone.[^lowcarbon]
...
![Four stacked bars: consumption of 192 kWh/d in MacKay's 2008 accounting against 161 in the 2026 revision, and production of 136 kWh/d as MacKay's maximum-conceivable ceiling against 4 actually generated in Britain in 2025.](/img/without-hot-air/fig-stacks.svg)

<span class="figurenumber">Figure 18.10.</span> The balance sheet, 2008 and 2026. *Added in the 2026 revision.* Consumption is a typical affluent person's use, revised chapter by chapter through this edition. Production sets MacKay's maximum-conceivable ceilings beside what Britain actually generated in 2025. The two halves are not the same accounting, and the gap between the third and fourth columns is a measure of distance from a physical limit, not a shortfall against a plan.[^stacks]
...
![Six countries traced from 1990 to 2025 with income on the horizontal axis and energy per person on the vertical. The five rich countries all move rightwards and downwards; China moves rightwards and steeply upwards from 18 to 87 kWh per day.](/img/without-hot-air/fig-energy-vs-gdp.svg)

<span class="figurenumber">Figure 18.11.</span> Energy per person against income per person, 1990 to 2025. Read across the countries at any one moment and the relationship is the one chapter L is about: nobody is rich on little energy. What matters here is the *path* each country has traced. Britain's runs down and to the right — 120 kWh/d to 69 while income rose by three fifths — and every other rich country's does the same, more gently. Only China's goes up, which is what industrialising looks like from the inside.[^evg]

![The same six paths with only fossil energy counted. Britain falls from 110 to 54 kWh per day, France from 77 to 46, and the United States from 214 to 171.](/img/without-hot-air/fig-fossil-vs-gdp.svg)
...
The first is a price ratio. Chapter 7: a heat pump moves three to five times more heat than a boiler makes, and still costs more to run in Britain, because a British household pays about 3.6 times as much for a kilowatt-hour of electricity as for one of gas. Sweden's ratio is 1.3, and Sweden's heat pumps are everywhere. The physics is identical in both countries.

The second is a queue. Chapter 11a: houses in west London could not be connected because data centres had taken the capacity, and a data centre turning a kilowatt-hour into eighty kronor of revenue outbids a house that turns it into nothing. No price signal produced that outcome. A connection queue did.

The third is a permit. Chapter 13: spraying from drones cuts herbicide by up to a third, and applying pesticide from a drone is prohibited in Britain under a rule written for crop-dusting aircraft, decades before the machine existed.

The fourth is a procurement cycle. Chapter 9: LED street lighting was technically ready around 2012 and is roughly half done, because it is not a four-pound bulb but twenty-nine separate council capital programmes, each with its own budget and borrowing constraint.

The fifth is a contract's expiry. Chapter 28a: Germany is dismantling the subsidy that built its renewables not because anyone concluded it was wrong, but because an EU state-aid approval expires on 31 December 2026.
...
[^lowcarbon]: Figure 18.9b is generated by the `ukLowCarbon` step of this edition's data-refresh script and `figures/uk_low_carbon.py`, from the Energy Institute's *Statistical Review of World Energy* 2026, divided by populations of 60.8 million for 2006 and 68.4 million for 2025. Generation in TWh: wind 4.2 to 87.1, solar nil to 20.0, hydroelectricity 4.6 to 5.1, biomass 8.5 to 40.5, nuclear 75.5 to 35.9. Two cautions. Biomass is counted here as low-carbon because that is how the British accounts treat it, and chapter 6 records why that convention is disputed — most of it is imported wood pellets, which chapter M puts at an energy return of 1.6. And this is generation, not capacity or consumption; net imports across the interconnectors are excluded, and chapter 25 records that they are material and rising.
...
[^evg]: Figures 18.11 and 18.12 are generated by the `energyVsGdp` step in this edition's data-refresh script from two Our World in Data charts — *Energy use per person vs. GDP per capita* and *Per capita fossil energy vs. GDP* — whose underlying series are total energy supply per person from the Energy Institute's *Statistical Review of World Energy* 2026 and GDP per person at purchasing-power parity in constant 2021 international dollars, compiled by Our World in Data from Eurostat, the OECD, the IMF and the World Bank. Energy is converted from the annual per-person total to kWh per day. Income is on a logarithmic axis because China's spans fifteenfold over the period while the rich countries' span less than two. The boundary is total energy supply, the same one the note above uses, which is why Britain begins figure 18.11 at 120 kWh/d rather than the 125 MacKay quotes; the difference is accounting, not disagreement. One trap for anyone re-running this: the fossil chart's download is served in MWh per person while its metadata declares kWh, so the two series need different conversions to reach the same units.

[^stacks]: Figure 18.10 is generated by the `stacks` step in this edition's data-refresh script. Consumption columns take the per-person figure each chapter arrives at: unchanged for cars, planes, gadgets, stuff, its transport, defence and universities, and revised for heating and cooling (37 to 13), light (4 to under 1) and food and farming (12 to 7), with data centres and the NHS estate added. Production ceilings are MacKay's own maximum-conceivable figures from chapters 4, 6, 8, 10, 12, 14 and 16; the 2025 column is Energy Institute generation for the United Kingdom divided by 68.4 million — wind 87.1 TWh, solar 20.0, hydro 5.1 — with tidal at the 28 MW contracted in AR6 and wave below the resolution of the series. Three cautions. The consumption columns describe an individual's delivered energy while the national figures quoted in the text are primary energy, so the two are not interchangeable. The production ceilings are bounds MacKay states are not forecasts. And the ceiling column omits biomass and solar hot water, which he also stacks, so it is a subset chosen to match the chapters this edition revisited rather than his full green stack.
