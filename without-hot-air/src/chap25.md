...
[^de4]: Net electricity imports (imports minus exports), Ember via Our World in Data, <https://ourworldindata.org/grapher/net-electricity-imports> . The share of supply uses German generation of 431.7 TWh in 2024, from the Bundesnetzagentur's 2024 electricity market data. UK generation for the 2017 comparison is about 290 TWh a year, from the same Our World in Data electricity dataset used elsewhere in this edition.
