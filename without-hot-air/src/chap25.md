...
![Daily mean electricity demand against daily mean temperature for Sweden, France, Great Britain, Germany, Spain and Italy, 2021 to 2026, with least-squares lines on the days below 15 C and above 20 C. France falls 2.14 GW per degree colder and rises 0.57 per degree hotter; Italy falls only 0.42 per degree colder but rises 1.01 per degree hotter; Sweden has no measurable summer arm.](/img/without-hot-air/fig-thermosensitivity.svg)
...
**Italy is the same picture upside down, and it is the picture Britain is heading towards from the other side.** Italy's winter arm is nearly flat at **0.42 GW per degree**, because Italy heats with gas and the electricity meter never sees it. Its summer arm is the steepest of the six at **1.01 GW per degree, 2.9% of mean load**. Spain is sensitive at both ends, Germany is contained at both, and **Sweden has no measurable summer arm at all** — thirty-three days above 20 °C in five and a half years, and a slope indistinguishable from zero.
