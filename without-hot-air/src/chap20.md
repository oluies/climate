...
**Turning energy into emissions needs one more number, and it is not this chapter's.** Eighty kWh of petrol is about eight litres, some 19 kg of CO<sub>2</sub>; 21 kWh drawn from a grid at 0.65 kg/kWh, which is roughly Poland's, is about 14 kg before the battery is amortised — still lower, but not by the factor the energy comparison suggests. On the French grid it is under 1 kg. **So the answer is that the electric car wins everywhere and wins by an amount that depends entirely on chapter 19's question**, and the gap narrows again as the car grows: a large electric pickup at 30 kWh/100 km carries far more manufacturing burden than a Citroën Ami at 7.3.[^myths]
