...
Set that beside the 3 kWh per 100 seat-km of a full train and the ratio is **more than four to one** — which is the occupancy table earlier in this chapter, measured rather than modelled. **The railway's real figure is not its best-behaviour figure, and the gap is the empty seats.** It remains six times better than a single-occupant car, on the same basis.
...
The second is that it is actually being done. London had **over 2000 zero-emission buses in service by June 2025**, about a fifth of the fleet, across 107 routes, with 2500 expected by the end of that year. This is one of the few places in this book where a technology that adds up has also been procured at scale — and it happened because a public authority bought the vehicles directly, which is the mechanism chapter 29 finds does the work.
...
<span class="figurenumber">Figure 20.22b.</span> The award-winning electric car, 2019 to 2026. *Added in the 2026 revision.* The dashed line is MacKay's Roadster. It took seven years for an electric Car of the Year to get back to its figure, and until 2026 to beat it.[^coty]
...
A **Tesla Model S Plaid** produces **1020 PS**, reaches 100 km/h in **2.1 seconds** — quicker than almost anything with an engine — and is rated at **15.7 kWh per 100 km**. That is MacKay's Roadster figure, from a four-seat saloon with five times the power. Against his petrol baseline of 80 it is **five times better while being one of the fastest-accelerating road cars ever built.** A **Porsche Taycan Turbo GT** does much the same at 1108 PS and about 19 kWh per 100 km.

The extreme end has moved further than anyone in 2008 would have credited. **BYD's Yangwang U9** is rated at 1306 PS in standard form and over 3000 in its track version; a U9 has recorded **496 km/h**, making the fastest production car in the world an electric one, and has taken the electric lap record at the Nürburgring. **Xiaomi's SU7 Ultra** has 1526 PS and reaches 100 km/h in under two seconds, for around $73 000 in China, with European sales announced for 2027. **Lotus**, British-badged and Chinese-owned through Geely, sells the Eletre and Emeya into the same segment.[^perf]
...
**And one of them is in note 16.** MacKay lists the *Berlingo Electrique 500E* — "an urban delivery van… 25 kWh per 100 km", from an estimate kindly supplied by an owner. Its direct descendant is now among the best-selling electric vans in Europe, with a 50 kWh battery and about 343 km of range, which is **14.6 kWh per 100 km**. The consumption nearly halved while the range grew fivefold.[^smallev]

**So of the eighteen vehicles in that catalogue, the two whose lineage survived are a sports car and a plumber's van.** The sports car got the attention. The van did the work, and did it while getting substantially more efficient — which is the opposite of what happened to cars, where the efficiency went into size and speed instead.
...
Two things fall out of that table. **A commuting e-bike uses less electricity than its rider uses food** — the only motorised vehicle in this book of which that is true, and a fair working definition of "efficient". And at the light-assist end it is **more than a hundred times better than the petrol car**, which is a larger factor than separates any other two rows in this chapter.[^ebike]
