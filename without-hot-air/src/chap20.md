...
[^24]: *Transrapid magnetic levitation train*. MacKay cited the manufacturer's site at <span class="websitetitle">www.transrapid.de</span>, which no longer resolves — the consortium behind it was wound down after the Shanghai line remained its only commercial deployment and the German Emsland test track closed in 2012 following the 2006 collision there. The page as MacKay would have seen it is at the [Internet Archive](http://web.archive.org/web/2015/http://www.transrapid.de); [Wikipedia](https://en.wikipedia.org/wiki/Transrapid) carries the project history. *Link updated in the 2026 revision.*
