...
![](/img/without-hot-air/figure422.gif)
...
![Energy taken from the socket against distance driven for an e-bike, a Citroen Ami, a best-in-class electric car, the electric fleet average, MacKay's G-Wiz and a large electric pickup. The G-Wiz and the fleet average lie on the same line at 21 kWh per 100 km.](/img/without-hot-air/fig-socket-energy.svg)

<span class="figurenumber">Figure 20.21b.</span> The same measurement, for what is on sale now. *Added in the 2026 revision.* The slope of each line is its consumption; MacKay's measured G-Wiz and today's real-world fleet average lie on top of each other at 21 kWh per 100 km.[^socket]
