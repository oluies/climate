...
![](/img/without-hot-air/figure135.gif)
...
![](/img/without-hot-air/figure134.gif)
...
<span class="figurenumber">Figure 20.2.</span> Team Crocodile’s eco-car uses <span class="mauve">1.3 kWh per 100 km</span>. Photo kindly provided by Team Crocodile. [<span class="websitetitle">www.teamcrocodile.com</span>](https://web.archive.org/web/20110201185547/http://www.teamcrocodile.com/)
...
But the energy was never the interesting part, and the comparison shows why. MacKay's 1 kWh per 100 person-km is food, supplied by the person pedalling. The cargo bike's 0.67 is electricity, supplied by a socket. The saving is not really in joules; it is in who has to produce them — and that is the whole reason a parent who would not tow two children up a hill on a trailer will do the same trip on an electric trike. The efficiency was spent on making the journey possible rather than on making it cheaper, which is the trade this chapter keeps finding.

The three-wheeled version is a second case of the same thing. A trike is not about cargo; it is about not having to balance, which returns cycling to people who had given it up. In an ageing Europe that is a larger category every year.

And it is happening at scale. More than 320 low-emission zones now operate across European cities, which has pushed parcel delivery onto bicycles: in Belgium alone, 5.2 million parcels were delivered by cargo bike in 2024, up 70% on the year before. Industry forecasts put European cargo bike sales near two million a year by 2030, split roughly evenly between commercial and family use.[^cargo]

![](/img/without-hot-air/figure139.gif)

<span class="figurenumber">Figure 20.4.</span> This 8-carriage train, at its maximum speed of 100mph (161 km/h), consumes <span class="mauve">1.6 kWh per 100 passenger-km</span>, if full. [^3]

A widely quoted statistic says something along the lines of "only *1 percent* of the energy used by a car goes into moving the driver" [^1] – the implication being that, surely, by being a bit smarter, we could make cars *100* times more efficient? The answer is yes, almost, but only by applying the principles of vehicle design and vehicle use, listed above, to *extreme* degrees.
...
![](/img/without-hot-air/figure136.gif)
...
In 2006–7, the total energy cost of all London’s underground trains, including lighting, lifts, depots, and workshops, was <span class="mauve">15 kWh per 100 p-km</span> [^6] – five times better than our baseline car. In 2006–7 the energy cost of all London buses was <span class="mauve">32 kWh per 100 p-km</span>. Energy cost is not the only thing that matters, of course. Passengers care about speed: and the underground trains delivered higher speeds (an average of 33 km/h) than buses (18 km/h). Managers care about financial costs: the staff costs, per passenger-km, of underground trains are less than those of buses.

![](/img/without-hot-air/figure140.gif)
...
## Public transport, redone for 2026

*A section added in the 2026 revision.* Figure 20.5 shows public transport "on best behaviour" — full vehicles, best practice, no allowance for empty seats. Two of its numbers have not moved at all and one has moved more than anything else in this chapter.

The trains have not changed, because they cannot. MacKay's full high-speed electric train at 3 kWh per 100 seat-km and his diesel at 9 are statements about steel wheels, air resistance and a motor, and eighteen years of engineering has not altered them materially. Rolling stock has got a little better; the figure has not.

What can now be added is the number he could only estimate: what the whole British railway actually achieves, with real passengers in real seats. The rail regulator publishes the inputs. In the year to March 2025 British trains drew 4098 GWh of traction electricity and burned 582 million litres of diesel, and passenger services accounted for about 82% of rail emissions. Against roughly 65 billion passenger-kilometres, that comes to about 13 kWh per 100 passenger-km.[^pt2026]

Set that beside the 3 kWh per 100 seat-km of a full train and the ratio is more than four to one — which is the occupancy table later in this chapter, measured rather than modelled. The railway's real figure is not its best-behaviour figure, and the gap is the empty seats. It remains six times better than a single-occupant car, on the same basis.

The buses are the largest improvement in this chapter. MacKay gives all London buses in 2006–7 at 32 kWh per 100 passenger-km, the worst public-transport figure in the book and worse than a shared car. Two things have happened since.

The first is the drivetrain. The best battery-electric double-decker tested to British standards uses 0.67 kWh per kilometre on the UK bus cycle — against something like 2.5 to 3 for the diesel it replaces, because a bus spends its life accelerating away from stops, which is where regenerative braking and the absence of a idling engine pay most. That is roughly a fourfold reduction at the vehicle, which would take MacKay's 32 to somewhere near 8.

The second is that it is actually being done. London had over 2000 zero-emission buses in service by June 2025, about a fifth of the fleet, across 107 routes, with 2500 expected by the end of that year. This is one of the few places in this book where a technology that adds up has also been procured at scale — and it happened because a public authority specified and procured the vehicles rather than waiting for a price signal to do it. That is the same shape chapter 29 finds throughout: action on what is available to buy, rather than on what it costs.

A caution about all of the above, and the reason this section does not redraw figure 20.5. MacKay's chart puts full vehicles on one axis and speed on the other, and every number on it is on the same basis. The numbers here are not: the rail figure is a whole system with real occupancy, the bus figure is a test cycle for one vehicle, and the two cannot honestly be plotted together. A chart would imply a precision the data does not carry. Figure 20.23b, which does plot across modes, marks its own basis for every point and should be read with the same suspicion.

## Private vehicles: technology, legislation, and incentives

![](/img/without-hot-air/figure145.gif)

<span class="figurenumber">Figure 20.10</span>. Special parking privileges for electric cars in Ann Arbor, Michigan.

![](/img/without-hot-air/figure146.gif)

<span class="figurenumber">Figure 20.11</span>. Monster cars are just tall enough to completely obscure the view and the visibility of pedestrians.
...
![The type-approval carbon dioxide figures of the 10.8 million new cars registered in the EU, Norway and Iceland in 2025, in five-gram bins, stacked by powertrain, with 2020 outlined behind. A fifth of all registrations sit in the single bin at zero. Three averages are marked: MacKay's 168 grams per kilometre for the UK in 2006, the official 2025 European average of 97, and 143 once the electricity behind the electric cars and the gap between test and road are counted.](/img/without-hot-air/fig-car-co2.svg)

<span class="figurenumber">Figure 20.9b.</span> MacKay's histogram drawn again, for what Europe bought in 2025. *Added in the 2026 revision.* He counted models on sale in one country; this counts cars registered across twenty-nine. His second horizontal scale in kWh per 100 km is kept, and it is meaningless for the two colours at the left-hand end.[^carco2]

### The showroom, eighteen years on

*A section added in the 2026 revision.* MacKay had to count his histogram off a car-buying website. Every European country now keeps the register for him: under the CO<sub>2</sub> regulation each member state records one row for every new car registered, with its type-approval emissions, and the European Environment Agency publishes the lot. Figure 20.9b is his figure 20.9 redrawn from that register — 10.8 million cars in 2025, against his one showroom.

**The shape.** The histogram has marched left, and it has grown a spike at zero. His average new UK car emitted 168 g CO<sub>2</sub> per km; the European average in 2025 was 97, and Britain's own was 92. Cars above 200 g/km are down to 2.3% of what Europe bought, from 4.3% five years earlier. On the face of it his argument has been won.

But the left-hand end of that chart is an accounting convention rather than a measurement, and it is worth separating the part of the improvement that is real from the part that is bookkeeping. Three corrections, in increasing order of how much they hurt.

**The zeros.** A fifth of the cars — 19.0% of registrations — are entered as zero. A battery-electric car is credited with nothing at the tailpipe and the regulation stops there. Charged on the European grid of 2024, about 213 g CO<sub>2</sub> per kWh, and driven at the real-world 21 kWh per 100 km of figure 20.21, that car emits around 45 g per km: five times better than the combustion cars beside it, and not zero.

**The plug-in hybrids.** These are typed at 32 g/km and metered at 145. Since 2021 every new car has carried a meter recording what it actually burns, and across 220 000 plug-in hybrids registered in 2024 the recorded average was 145 g/km against the 24 their tests gave them — six times over. This is not a failure of the machinery; it is that the test assumes the car is driven on electricity far more than its owners drive it on electricity.

**The petrol and diesel cars.** These are optimistic too. The same meters put their real-world average at 169 g/km where their type approvals say 132.

**The total.** Put the three together and the 97 becomes 143: the average new European car of 2025 emits about half as much again as its paperwork says. MacKay's 168 was itself a test figure with its own gap — the ICCT's series has the divergence between the old NEDC test and the road at about 9% in 2001 rising to 42% by 2016, so the real car behind his number was nearer 190. The honest comparison is something like 190 down to 143, a fall of about a quarter in two decades, where the official comparison advertises 168 down to 97. Real progress, at roughly half the advertised rate.

**MacKay's ceilings.** His own legislative proposal can now be marked. He suggests banning the sale of any car using more than 80 kWh per 100 km, then tightening the ceiling to 60, then to 40. At his own 240 g per kWh those are 192, 144 and 96 g CO<sub>2</sub> per km, and the register says what each would have caught.

| MacKay's ceiling | as g CO<sub>2</sub>/km | banned on paper | banned on the road |
|---|---|---|---|
| 80 kWh per 100 km | 192 | 3.6% | 12% |
| 60 kWh per 100 km | 144 | 15% | 68% |
| 40 kWh per 100 km | 96 | 71% | 81% |

His first ceiling has arrived without ever being legislated: 96% of the cars Europe bought in 2025 clear it, against 93% in 2020. His second is half-arrived on paper and not arrived at all on the road — fifteen cars in a hundred fail it as typed, and more than two thirds fail it as driven. His third would still ban seven cars in ten, and four in five once the road is counted. The ceiling he expected to be a distant third step is, on the measured numbers, further away than his first step was when he wrote.

**The spread.** The other half of his argument is untouched. He writes figure 20.9 to show that the range on offer is enormous and that buyers spread themselves across it, which is why he thinks choice needs constraining. That is still true: the combustion cars in the 2025 register run up to 500 g CO<sub>2</sub> per km, and twenty thousand cars above 300 were registered in a year when the average was 97. And because this chart counts cars sold rather than models offered, it understates the range in the showroom — the far right of it is thinly populated precisely because few people buy there, not because it is not for sale.

![](/img/without-hot-air/figure143.gif)

<span class="figurenumber">Figure 20.12</span>. A roundabout in Enschede, Netherlands.

![](/img/without-hot-air/figure147.gif)
...
![](/img/without-hot-air/figure149.gif)
...
![](/img/without-hot-air/figure150.gif)
...
![](/img/without-hot-air/figure152.gif)
...
![](/img/without-hot-air/figure153.gif)
...
![](/img/without-hot-air/figure421.gif)
...
![Energy taken from the socket against distance driven for an e-bike, a Citroen Ami, a best-in-class electric car, the electric fleet average, MacKay's G-Wiz and a large electric pickup, with a grey wedge for the spread of MacKay's own nineteen recharges. The G-Wiz and the fleet average lie on the same line at 21 kWh per 100 km.](/img/without-hot-air/fig-socket-energy.svg)

<span class="figurenumber">Figure 20.21</span>. Electricity required to recharge an electric vehicle versus distance driven, measured at the socket. *Replaces MacKay's own figure 20.21 in the 2026 revision, carrying its three numbers rather than printing it separately.* The slope of each line is its consumption. MacKay's measured G-Wiz and today's real-world fleet average lie on top of each other at 21 kWh per 100 km; the grey wedge is the spread of his own nineteen recharges, from a best of 16 to a worst of 33.[^socket]
...
![European Car of the Year winners that were electric, with their WLTP consumption: Jaguar I-Pace 2019 at 22 to 25.2, Kia EV6 2022 at 15.9 to 20.9, Renault Scenic 2024 at 13.3 to 17.8, Renault 5 in 2025 at 14.9 and Mercedes-Benz CLA in 2026 at 12.2 to 14.1, against MacKay's Roadster at 15.](/img/without-hot-air/fig-coty-efficiency.svg)

<span class="figurenumber">Figure 20.22b.</span> The award-winning electric car, 2019 to 2026. *Added in the 2026 revision.* The dashed line is MacKay's Roadster. The winners fell from 22–25 kWh per 100 km in 2019 to 12–14 in 2026, reaching under his figure with their best variants from 2024 and sitting wholly below it by 2026.[^coty]

And every number on that chart is optimistic, which is worth saying plainly because this book's own units invite the mistake. WLTP is a test cycle: it runs at moderate temperatures and barely loads the cabin. A real car's heat pump draws 0.5 to 1 kW while driving, and more on a cold start in hard frost. At 50 km/h that alone is 1 to 2 kWh per 100 km — a tenth or more on top of a 14 kWh figure — and it is why measured consumption in the same fleet runs near 14 kWh per 100 km in summer and 26 in December. The heating is not a rounding error; in a British or Nordic winter it is the second-largest load in the car after moving it.

### The muscle-car argument, won more completely than he needed

MacKay puts the Roadster in this chapter to make one point: you do not have to give up performance to save energy. His muscle car used 15 kWh per 100 km where a G-Wiz used 21. Eighteen years later that argument has been won so thoroughly that it now reads as understated.

A Tesla Model S Plaid produces 1020 PS, reaches 100 km/h in 2.1 seconds — quicker than almost anything with an engine — and is rated at 15.7 kWh per 100 km. That is MacKay's Roadster figure, from a four-seat saloon with about four times the power. Against his petrol baseline of 80 it is five times better while being one of the fastest-accelerating road cars ever built. A Porsche Taycan Turbo GT does much the same at 1108 PS and about 19 kWh per 100 km.

The extreme end has moved further than anyone in 2008 would have credited. BYD's Yangwang U9 is rated at 1306 PS in standard form and over 3000 in its track version; a U9 has recorded 496 km/h, making the fastest production car in the world an electric one, and has taken the electric lap record at the Nürburgring. Xiaomi's SU7 Ultra has 1526 hp, about 1548 PS, and reaches 100 km/h in under two seconds, for around $73 000 in China, with European sales announced for 2027. Lotus, British-badged and Chinese-owned through Geely, sells the Eletre and Emeya into the same segment.[^perf]

Two things follow, and the second is the one this chapter cares about.

The first is simply that MacKay was right, and more right than he claimed. He hedged the Roadster as "an early prototype… a luxury car with lots of muscle" and used it to argue that electric drive need not mean a milk float. The hedge is no longer needed.

The second is a caution his own chapter A supplies. These figures are test-cycle numbers at ordinary speeds, and none of these cars is bought to be driven at ordinary speeds. Air resistance scales with the cube of speed for power: a car at 300 km/h is spending roughly twenty-seven times the drag power of the same car at 100. A 15.7 kWh per 100 km rating tells you what a Plaid does in traffic; it tells you nothing whatever about what it does when used as designed, and the honest figure for that is several times worse.

And the spread inside the electric fleet is now as wide as MacKay's entire original comparison. From the Ami at 7.3 through the Plaid at 15.7 to a heavy electric sport-utility at 22 and a pickup near 30 is a factor of four — about the range his whole 2008 catalogue covered. Electrification settled the question of what the drivetrain costs. It did not settle the question of how big and how fast, and chapter A says that is the question that was always doing the work.

That is the honest reconciliation between figure 20.22b and figure 20.21. The test-cycle numbers say 13 to 15. The real-world fleet average is 21. The difference is speed, cold, and the fact that a person inside a car expects to be warm — and MacKay's own G-Wiz measurement, taken at the socket in real British weather, was on the right side of that gap all along.
...
![](/img/without-hot-air/figure156.gif)
...
Here are some numbers.
  ...
  - Fuelling the *Hydrogen 7*, the hydrogen-powered car made by BMW, requires <span class="mauve">254 kWh per 100 km</span> – *220% more* energy than an average European car. [^20]
...
![](/img/without-hot-air/figure157.gif)
...
The third is that the American list is the heavy one. The Equinox and the Mach-E are mid-size sport-utility vehicles, and the best-selling electric pickup is a far larger machine than the Seagull — though the caution below means the two cannot be compared on their published consumption figures. The same technology, in three markets, is being used to make very different vehicles — which is chapter A's point again, and the reason the fleet average sits at 21 kWh per 100 km rather than the 15 MacKay expected.
...
### The small end, where the arithmetic is best
...
| | kWh per 100 km |
|---|---|
| MacKay's baseline petrol car | 80 |
| European electric fleet, real-world | 21 |
| Citroën Ami | **7.3** |
...
So of everything in that catalogue, the two lineages that survived are a sports car and a plumber's van. The sports car got the attention. The van did the work, and did it while getting substantially more efficient — which is the opposite of what happened to cars, where the efficiency went into size and speed instead.

### And below that, the electric bicycle

*A section added in the 2026 revision.* The smallest motorised thing in this chapter is also the one Europe has bought most of, and it barely appears in the original book because in 2008 it barely existed.

Europe now buys about five million electric bicycles a year — 5.1 million in 2023, 5.5 million in 2022, easing slightly since as the pandemic boom unwound. Germany is the largest market and France the second. Set that beside roughly two and a half million battery-electric *cars* sold across the EU, UK and EFTA in 2025 and the comparison is stark: Europe buys about twice as many electric bikes as electric cars.

The energy figures depend heavily on how hard the rider works, and it is worth giving the range rather than a single number:

| | kWh per 100 km |
|---|---|
| E-bike, light assist — a 500 Wh battery over 80 km | **0.6** |
| Electric mountain bike, worked hard | 1.5 |
| Loaded cargo bike, urban delivery | 2.0 |
| Family cargo bike, rider and two children — per person | 0.67 |
| MacKay's unassisted cyclist, as food energy | 1.6 |
| Citroën Ami | 7.3 |
| European electric car fleet, real-world | 21 |
| MacKay's baseline petrol car | 80 |

Two things fall out of that table. A commuting e-bike uses less electricity than its rider uses food — the only motorised vehicle in this book of which that is true, and a fair working definition of "efficient". And at the light-assist end it is more than a hundred times better than the petrol car — the widest gap between any two rows in that table.[^ebike]

The industry has the shape this edition keeps finding. There are hundreds of brands — Scott, Specialized, Trek, Cube, Riese & Müller, Gazelle, Rawbike, Ecoride, Crescent — and only a handful of drive systems: Bosch eBike Systems dominates, with Shimano, Bafang, Brose and Yamaha behind it. Many badges, few motors, which is the fabricated-not-constructed pattern from the electrofuel section arriving in a bicycle shop. It is also why the category got cheap and good quickly: the expensive part is made in volume for everybody.

**The family bike.** The vehicle that has actually replaced a car is the family cargo bike. Germany is the market to count it in, because its industry association publishes the numbers: 220 300 cargo bikes were sold there in 2025, of which 185 300 — 84% — were electric. It was the fourth successive year above two hundred thousand, and the cumulative total since the count began passed a million. One in ten of every e-bike sold in Germany is now a cargo bike. Set beside that the fact that Germany had 17.2 million e-bikes in use at the end of 2025 and 2.03 million battery-electric cars, and the sentence the German industry writes about itself — that the e-bike *is* electric mobility on German roads — is arithmetic rather than boosterism. It outnumbers the electric car more than eight to one.[^familybike]

**Box, longtail, trike.** Two shapes have won, and they are not the same vehicle. The box bike — the Dutch *bakfiets*, the Danish Long John — puts a load bay between the rider and the front wheel, where children sit facing the rider and the weight is low and visible; it is long, it handles oddly at first, and it will take two or three children and the shopping. The longtail stretches the rear of an ordinary bicycle instead, carries its load behind the rider, and is much easier to park and to ride, at the cost of not being able to see what it is carrying. A third shape, the trike, sells to people who do not want to balance at all — which, as the note at figure 20.3 says, is the point of it. All three are typically rated to carry 150 to 200 kg and come out at 2 kWh per 100 km loaded, which for a rider and two children is 0.67 kWh per 100 person-km.

**The evidence.** That it replaces a car is better attested than one might expect, and more equivocal than the industry quotes it as being. The largest survey of private owners is Swiss: 696 households, asked what changed after they bought one. Some 45.5% of them live without a car, against 22% of Swiss households generally and 7% of Swiss *family* households, and 31.2% had given up a car while 30.9% had given up buying one. The most frequent trip is the school run, which 68.5% make weekly. But look at what the trips came from. Asked which modes the cargo bike replaced, owners named public transport (58.6%) ahead of a privately owned car (46.1%), and 30.6% now walk less. A third of a car-replacement story, a third of a bus-replacement story, and a slice of trips that were previously made on foot — which is a loss, not a gain. And the sample is self-selected: these are people who bought a cargo bike, recruited through cycling associations, so it measures what enthusiasts did and not what a population would do.[^familybike]

**Babboe.** It is a vehicle, and it took a vehicle's accident to make the industry admit it. In February 2024 the Dutch product safety authority stopped Babboe, the largest family cargo bike brand in Europe, from selling anything at all: frames were cracking and breaking, and the company had been receiving reports for years without passing them to the regulator as the law requires. Roughly 22 000 bikes were recalled and replaced worldwide. A bicycle carrying two children at 25 km/h with 200 kg on the frame is not a bicycle in the sense the regulations grew up around, and the industry is only now being made to build and certify accordingly.[^familybike]

A few of them brake regeneratively, which the section on cars above discusses at length and which most e-bikes cannot do at all. The reason is mechanical rather than electrical, and it is a rule about transmissions rather than about brands: every mid-drive motor delivers through the chain, and every geared hub motor sits behind a freewheel, so in both cases the wheel can turn without turning the motor and there is nothing to generate with. Only a direct-drive hub motor is rigidly coupled to the wheel. Of the suppliers named above, Bosch, Shimano, Brose and Yamaha are mid-drives; Bafang builds both, and its direct-drive hubs can recover. The rule wants stating more carefully than that, though, because there is now an exception to it. What blocks regeneration is the freewheel, wherever in the transmission it sits, and not the position of the motor. Valeo's *Cyclee*, a mid-drive with a seven-speed gearbox built into the bottom bracket, 130 Nm of torque and a rating for 315 kg of bicycle, rider and load, advertises regenerative braking; it can only do so by having no freewheel between the motor and the rear wheel, which is a design decision a gearbox makes possible and a derailleur does not. Zehus's *Bike+*, at the opposite end, is a direct-drive hub with everything inside the wheel, and recovers when the rider pedals backwards. So the category is opening up, from one Swiss manufacturer to several, and it is opening up first on the machines that are heavy. Stromer, which uses one, offers two braking strengths — RECUP 1 for light descents and RECUP 2 for steep ones — and switches the recovery off when the battery is full, since a full battery has nowhere to put it.[^ebikeregen]

The arithmetic says where this is worth having, and it has to be done carefully, because most of the energy never reaches the brake. A rider and machine of about 100 kg descending 100 metres give up *mgh* = 98 kJ, or 0.027 kWh — but that is what gravity supplies, not what is available to recover. Rolling at 10 m/s down a 5% gradient, gravity contributes about 490 W while air drag and rolling resistance take some 300 W of it, so under two fifths reaches the brakes at all; on a gentle descent the rider does not brake, and the recoverable share is nothing. Of the fraction that does reach them, MacKay's figure for electrical regeneration in a car is about half captured, and that is half into the battery, before the losses of getting it out again. Put those together and a 100 metre descent returns something like 0.005 kWh. At 1.5 kWh per 100 km — the mountain-bike figure from the table, which is the right one for the terrain this is about — that is a few hundred metres of riding. Stopping from 25 km/h is worth less still: 2.4 kJ, about forty-five metres gross and perhaps twenty recovered.[^ebikeregen2]

So a bicycle inverts MacKay's finding for cars. He notes that regenerative braking pays most in *city* driving, where a heavy vehicle is repeatedly accelerated and stopped. A bicycle is too light for its stops to be worth much, and on the flat the recovery is a rounding error. In the hills it is real but modest, and it is worth having mostly because a long descent would otherwise heat a rim — which is presumably why the manufacturer that fits it is Swiss.

**The loaded case.** Do the same sum for a family bike and it improves, for the reason MacKay would predict: mass. Take 250 kg of bicycle, rider and two children down the same 100 metres. Gravity now supplies 0.068 kWh rather than 0.027, and — this is the part that matters — a far larger share of it reaches the brakes, because air drag and rolling resistance rise much more slowly with mass than weight does. At the same 10 m/s on the same 5% gradient, gravity contributes about 1230 W against some 500 W of resistances, so three fifths reaches the brakes rather than under two fifths. Through the same round-trip losses that is about 0.017 kWh recovered, which at the cargo bike's 2 kWh per 100 km is something like eight hundred metres of riding, against three hundred for the light machine. Four times better, and still under a kilometre. The case for fitting it is not the eight hundred metres. It is the 700 watts that would otherwise be going into a brake for the whole length of the descent, on a vehicle whose stopping distance is somebody else's children.[^ebikeregen2]

And the picking-winners lesson from note 16 repeats on a shorter timescale. VanMoof, the most heavily funded and most written-about e-bike company in Europe, went bankrupt in 2023 after raising around $200 million. The category thrived; the celebrated company did not.

The cargo bike deserves its own line, because it is the only vehicle in this chapter competing directly with the vans above. In dense European cities it now does a material share of parcel delivery at around 2 kWh per 100 km against the ë-Berlingo's 15 — and the comparison flatters the van, because a bicycle does not queue, does not need a loading bay, and does not have to be parked. This chapter's arithmetic says the smallest vehicle that will do the job wins, and freight is where that is being tested hardest.
...
![](/img/without-hot-air/figure160.gif)

<span class="figurenumber">Figure 20.30</span>. TSS Rijndam.

![](/img/without-hot-air/figure1611.gif)
...
![](/img/without-hot-air/figure162.gif)
...
The report is a think-tank argument for British strategic advantage and should be read as one — its framing is national-security and industrial-policy, and its recommendations are shaped to give Britain a role. But the diagnosis does not depend on the framing. The UK-registered trading fleet is 0.4% of world deadweight tonnage, or about 4% once ships beneficially owned or managed from Britain are counted, and it will not out-build East Asia; what it still holds is the IMO's headquarters and an insurance market that wrote £104.8 billion of premiums in 2024. On this particular obstacle, those are the relevant assets, which is an unusual thing to be able to say about an energy technology.[^policyexchange]

### The naval record, and the fuel that makes it possible

The merchant record above is not the whole record, and taken alone it is misleading, because the overwhelming majority of nuclear ships that have ever sailed were warships.

The American record is the strongest argument in the subject. The United States Naval Nuclear Propulsion Program has accumulated over 7600 reactor-years of operation with no reactor accident since *Nautilus* went critical in 1955 — across 273 reactor plants and 562 reactor cores, in a fleet that today numbers 77 nuclear-powered ships — having steamed something like 233 million kilometres. That is the largest body of operating experience with small reactors anywhere in the world, civil or military, and it is why the engineering claim in the reports above is credible rather than promotional. Carriers and submarines have done this in the least forgiving environment there is — sealed, mobile, shock-loaded, and far from help.

The Soviet and Russian record is genuinely mixed, and both halves matter. On the achievement side: the world's only fleet of nuclear icebreakers, the only nuclear merchant ship that ever had a career, and at Pevek since December 2019 the *Akademik Lomonosov*, a moored floating nuclear plant — which is to say the Core Power *Liberty* concept, already operating, built by somebody else. On the other side, roughly ten reactor accidents: K-19 losing primary coolant in the North Atlantic in 1961; K-11's two accidents during core loading in 1965; K-27's core damage in 1968, which gave nine crewmen fatal doses; and the refuelling explosion aboard K-431 at Chazhma Bay in 1985, which killed ten. The difference between the two records is not the physics. It is standardisation, training and maintenance culture, which is exactly what the American programme attributes its own record to.

One point of correction, since it recurs: Ukraine has never operated a nuclear-powered warship. What it did was build one. The Soviet Union's only nuclear-powered aircraft carrier, *Ulyanovsk*, was laid down at the Black Sea Shipyard in Nikolayev — now Mykolaiv — in November 1988, and was scrapped there on the slipway by independent Ukraine in 1992 at about 40% complete. The yard that would have made the USSR a nuclear carrier navy is the yard that ended it.[^navalrecord]

And here is why none of that transfers. American and British naval reactors run on uranium enriched to around 93% — weapon-grade. This is legal because the safeguards agreements concluded under the Non-Proliferation Treaty provide for nuclear material to be withdrawn from safeguards for non-proscribed military use, and naval propulsion is the canonical case; once the fuel is sealed into a submarine the International Atomic Energy Agency cannot verify it in the field. That "naval loophole" has been a quiet problem for fifty years and a loud one since the AUKUS submarine agreement, which requires it to be exercised by a state without nuclear weapons for the first time.

A shipping line cannot go anywhere near that fuel. No commercial operator will be licensed to hold weapon-grade uranium, insure it, or take it into Rotterdam. Which is precisely why every civil design in this section assumes something else — molten-salt reactors at civil enrichments — and why France is the interesting counter-example: its Suffren-class submarines run at under 6% enrichment, achieved by enlarging the core rather than the reactor, at the cost of refuelling more often. China is generally assessed to use low-enriched fuel too, though its naval enrichment is not publicly confirmed and published estimates vary.

So the naval record is evidence for the engineering and not for the business, and conflating the two is the error to avoid. Those 7600 safe reactor-years were bought with a fuel, a training pipeline, a maintenance regime and a legal exemption that no container line will ever have.[^navalfuel]

### Convoys, and the reason they keep being proposed

There is a variant worth setting out, because it is the obvious answer to the economics and it has a name. Instead of a reactor in every hull, put one large reactor in one hull and let it power several. A ship carrying a 345 MW reactor could supply propulsive electricity to about four large ships, whose main engines run around 80 MW — or to roughly twenty feeder ships, whose engines are nearer 15 MW. The ratio is the whole point, and it depends entirely on what size of ship is being served. The Norwegian designer Ulstein has taken the idea furthest with a matched pair: *Thor*, a replenishment and rescue vessel carrying a thorium molten-salt reactor, and *Sif*, a battery-electric expedition cruise ship that *Thor* recharges at sea; *Thor*'s charging capacity is sized for four *Sif*s at once. Core Power's *Liberty* programme proposes the moored version — floating nuclear plants built on a shipyard production line, towed to a port, powering the ships tied up alongside as well as the shore.[^nucconvoy]
...
![](/img/without-hot-air/figure163.gif)
...
Making a battery does emit more than making a fuel tank, and the claim fails on the size of the two numbers rather than on the direction. This chapter settles the energy half of it, which is the half it can settle: a European electric car uses about 21 kWh per 100 km at the socket in real use, against MacKay's 80 kWh per 100 km of chemical energy for the average petrol car. The running energy is roughly a quarter, and that is the gap a manufacturing penalty paid once has to overcome across a whole lifetime.

Turning energy into emissions needs one more number, and it is not this chapter's. Eighty kWh of petrol is about eight litres, some 19 kg of CO<sub>2</sub>; the same distance for a fleet-average electric car at 21 kWh drawn from a grid at 0.65 kg/kWh, roughly Poland's, is about 14 kg before the battery is amortised. On the French grid it is under 1 kg. So the size of the win is chapter 19's question, not this one's, and on a coal-heavy grid it is a margin rather than a factor — narrow enough that the manufacturing penalty matters, which is why the honest form of the answer is a breakeven distance rather than a verdict. Vehicle size moves it the same way: a large electric pickup at 30 kWh/100 km on that same grid is about 19.5 kg, level with the petrol car before any battery is counted, while a Citroën Ami at 7.3 is under 5 kg even on the dirtiest grid used here.[^myths]
...
[^2]: *The bicycle’s performance is about the same as the eco-car’s.* Cycling on a single-person bike costs about 1.6 kWh per 100 km, assuming a speed of 20 km/h. For details and references, see [Chapter A](../Text/chapA.xhtml#bike).

[^3]: *The 8-carriage stopping train from Cambridge to London* (figure 20.4) weighs 275 tonnes, and can carry 584 passengers seated. Its maximum speed is 100mph (161 km/h), and the power output is 1.5 MW. If all the seats are occupied, this train at top speed consumes at most *1.6 kWh per 100 passenger-km*.
...
[^12]: *the average new car in the UK emits 168 g CO<sub>2</sub> per km*. This is the figure for the year 2006 (King, 2008). The average emissions of a new passenger vehicle in the USA were 255 g per km (King, 2008).

[^13]: *The Toyota Prius has a more-efficient engine*. The Prius’s petrol engine uses the Atkinson cycle, in contrast to the conventional Otto cycle. By cunningly mixing electric power and petrol power as the driver’s demands change, the Prius gets by with a smaller engine than is normal in a car of its weight, and converts petrol to work more efficiently than a conventional petrol engine.

[^14]: *Hybrid technologies give fuel savings of 20% or 30%*. For example, from Hitachi’s research report describing hybrid trains (Kaneko et al., 2004): highefficiency power generation and regenerative braking are "expected to give fuel savings of approximately 20% compared with conventional diesel-powered trains."
...
[^ebikeregen]: The RECUP 1 and RECUP 2 modes, their use on light and steep descents, and the fact that recovery is disabled when the battery is full are from Stromer's own support documentation, <https://www.stromerbike.com/en/support/faq/battery/what-do-the-regenerative-braking-modes-recup-1-and-recup-2-mean-for-the>. Stromer publishes no figure for how much energy the modes actually return, so the numbers in the text are this book's own arithmetic and not the manufacturer's claim. The claim that mid-drive and geared-hub systems cannot regenerate is a statement about their transmission rather than about any particular product — a freewheel by construction lets the wheel overrun the motor — which is why the text states it as a rule and then sorts the named suppliers by it. Bafang is the one that appears on both sides, since it builds mid-drives and direct-drive hubs alike. The exception added in this revision is Valeo's, whose *Cyclee* system — a bottom-bracket motor with a seven-speed automatic gearbox developed with Effigear, 130 Nm of torque, rated for 315 kg all-up including the bicycle, and sold to Ultima, FUELL, Cavalerie and others — lists regenerative braking among its features. Valeo publishes no figure for what it returns either, and the arithmetic in the text applies to it unchanged. It is included because it disproves the tidy form of the rule: a mid-drive *can* regenerate, provided the transmission between it and the wheel is rigid, which an integrated gearbox permits and a rear derailleur and cassette do not. Zehus's *Bike+*, an all-in-one direct-drive rear hub that engages recovery on a few backward pedal strokes, is the other system named; it is the same physics as Stromer's in a different package. None of the three publishes a recovered-energy figure, which is itself informative.

[^ebikeregen2]: The arithmetic, term by term. Gravity: 100 kg descending 100 m gives *mgh* = 100 × 9.81 × 100 = 98 kJ = 0.027 kWh. The 100 kg is a round figure — a Stromer ST model is around 30 kg, heavy for a bicycle because of the battery and the direct-drive hub. What reaches the brakes is much less, and this is the deduction that matters most for a light, un-aerodynamic vehicle: at 10 m/s on a 5% gradient gravity supplies about 490 W, while air drag at a drag area near 0.4 m² takes roughly 245 W and rolling resistance at a coefficient of 0.006 about 60 W, leaving under 190 W — under two fifths — for the brakes to absorb. On a shallower gradient the resistances take all of it, the rider does not brake, and nothing is recoverable. The share is therefore gradient- and speed-dependent and the two fifths is illustrative rather than general. Of what does reach the brakes, this chapter's only figure for *electrical* regeneration is MacKay's own, "roughly 50% of the car's energy in a braking event"; note that his 70% figure nearby is for hydraulic and flywheel systems and does not apply here. His 50% is capture into the battery, one way — getting it out again through the battery and motor costs perhaps a further tenth or fifth, so the round trip is nearer 40–45%. Two fifths of 0.027 kWh, times something over two fifths again, is about 0.005 kWh. Converted at the mountain-bike figure of 1.5 kWh per 100 km rather than the flat, light-assist 0.6, since the recovery only happens in hilly riding, that is roughly 300 m. The stop: 100 kg from 25 km/h (6.9 m/s) is ½*mv*² = 2.4 kJ = 0.00067 kWh, which at 1.5 kWh per 100 km is about 45 m gross and some 20 m after the same round-trip losses — a hard stop dumps its energy quickly, and the same capture fraction is used here as on the descent rather than a worse one, for want of a bicycle-specific measurement either way. Note finally that a bicycle already has a form of regeneration a car does not: the rider, who can be pedalling on the descent instead of braking, and who on a light machine is the larger part of the system's mass. The loaded case, term by term. 250 kg is a family box bike at close to its rated weight — the machine itself is 35 to 45 kg, and a rider and two children with the shopping is most of the remaining 200. Gravity: 250 × 9.81 × 100 = 245 kJ = 0.068 kWh. At 10 m/s on 5%, gravity supplies 1226 W; air drag at a drag area of 0.5 m² — a box bike is a worse shape than a road machine, not a better one — takes 306 W, and rolling resistance at a coefficient of 0.008 on wide tyres takes 196 W, leaving 724 W, or 59%, for the brakes. The improvement over the light machine is entirely this share, and it comes about because weight scales with mass while drag does not scale with it at all. Through the same 42% round trip that is 0.017 kWh, which at 2 kWh per 100 km is 845 m; the text rounds to eight hundred. A stop from 25 km/h is 6.0 kJ against the light machine's 2.4, or about 35 m recovered. Every caution above applies here too, and one more: the 0.5 m² and the 0.008 are this book's estimates for a vehicle nobody publishes coastdown data for, and the 59% moves by several points if either is wrong.

[^familybike]: German market figures are the Zweirad-Industrie-Verband's *Marktdaten der Fahrradwirtschaft 2025*, presented 11 March 2026: 220 300 cargo bikes sold in 2025 against 220 500 in 2024, of which 185 300 electric and 35 000 not, with e-cargo up 0.4% and unmotorised down 2.8% on the year; cargo bikes are 9.5% of German e-bike sales and 2.0% of unmotorised bicycle sales; the German e-bike stock is 17.2 million, from 2.6 million in 2015. The 2.03 million battery-electric cars is the Kraftfahrt-Bundesamt's stock figure for 1 January 2026, the first time it passed two million. The two are not the same kind of vehicle and the eight-to-one is not a claim that they do the same work — it is a statement about how many electric motors are on the road, and about where the electrification of German transport has actually happened, which is not where the policy debate is. A cargo bike is also bought alongside a car far more often than instead of one, as the Swiss survey below shows. That survey is Dimitri Marincek, Patrick Rérat and Virginie Lurkin, "Cargo bikes and their modal shift effects: from substitution to car renunciation", *Transportation* 53(4), first published 5 December 2024: 696 owners, surveyed online between 13 June and 20 September 2022, recruited through cycling associations, social media, flyers left on parked cargo bikes and two shops. The authors say plainly that the sample is not geographically representative and over-represents French-speaking Switzerland. Every percentage quoted here is theirs: 45.5% car-free against 22% nationally and 7% of family households; 31.2% gave up a car and 30.9% gave up buying one; 68.5% do the school run weekly, 65.6% the shopping and 57.1% a commute; previous modes named were public transport 58.6%, private car 46.1%, car sharing 15.4%, bicycle 46%, e-bike 10.5% and walking 37.9%; since adopting, 59.7% use the car less, 58.9% public transport less and 30.6% walk less. The substitution result is the one to keep. A vehicle that takes trips off public transport and off foot as readily as off the car delivers much less than the headline "a third gave up a car" suggests, and the authors' own typology puts only 25.3% of the sample in the group that actually became car-free. Switzerland is also the wrong country to generalise from in one specific way: its public transport is unusually good, so there was more of it to substitute. Copenhagen's widely quoted figure, that about a quarter of families with two or more children own a cargo bike, is the city's own and dates from the early 2010s; it is a decade old and is repeated here as the order of magnitude it has always been, not as current data. The Babboe recall: the Nederlandse Voedsel- en Warenautoriteit told Babboe on 14 February 2024 that it had not shown its models to be free of safety risk, the company halted sales of its whole range and told owners to stop riding, and in April announced replacement of about 22 000 frames; the regulator had been receiving reports of frame breakage which the company had not passed on as required. Babboe belongs to Accell, the Dutch group that also owns Koga and Raleigh. Smaller recalls followed in the United States (about 300 bicycles) and Canada (about 445).

[^cargo]: The 2 kWh per 100 km for a loaded urban cargo bike is the 20 Wh/km operators' figure cited in the e-bike note below, and the per-person figures divide it by the number of people carried without allowing for the extra mass of the passengers, which would raise it somewhat; MacKay's 1 kWh per 100 person-km for a bicycle and trailer is his own and is food energy. The two are therefore not the same commodity, which is the point the note makes rather than a defect in the comparison. More than 320 low-emission zones operate in European cities; Belgian cargo-bike parcel deliveries of 5.2 million in 2024 against 3 million in 2023 are from industry reporting. The forecast of about two million European cargo bike sales a year by 2030, split roughly evenly between commercial and family use, is an industry projection rather than an observation, and projections in this sector have run ahead of outturn before — European e-bike sales were forecast to reach 6.5 million by 2025 and came in nearer 5.

[^pt2026]: Rail figures are from the Office of Rail and Road's *Rail environment* statistics for April 2024 to March 2025: 4098 million kWh of traction electricity, 582 million litres of traction diesel, total rail emissions of 2460 ktCO2e of which passenger trains were 2011, and passenger train emissions of 31 gCO2e per passenger-kilometre. The 13 kWh per 100 passenger-km is this edition's arithmetic, not the ORR's: diesel is converted at 10.5 kWh per litre, the passenger share of traction energy is assumed equal to the passenger share of emissions at 82%, and passenger-kilometres are taken as about 65 billion, interpolating between the 60 billion reported for the year to March 2024 and the higher quarterly figures since. Each of those three steps introduces error, and the electricity and diesel are added as delivered and chemical energy respectively, which is MacKay's convention but understates the primary energy behind the electric half. Treat the result as "about 13", not 12.9. Bus figures: the Alexander Dennis Enviro400EV's 0.67 kWh/km is a Zemo Partnership test-cycle result for the most efficient battery-electric double-decker so tested, not a fleet average, and real service consumption will be higher; the diesel comparison of 2.5–3 kWh/km equivalent is indicative. London's zero-emission fleet passing 2000 vehicles by June 2025, about 20% of the fleet across 107 routes, is Transport for London's.

[^perf]: Tesla Model S Plaid: 1020 PS, 0–100 km/h in about 2.1 s, 100 kWh battery, WLTP range about 611 km and consumption 15.7 kWh/100 km. Porsche Taycan Turbo GT: 1108 PS, 105 kWh battery, WLTP range up to about 553 km, giving roughly 19 kWh/100 km when derived from those two figures rather than quoted directly. BYD Yangwang U9: about 1306 PS standard, with a track version quoted above 3000 PS; a U9 variant recorded 496 km/h at Papenburg and has held the electric Nürburgring lap record, which BYD and Xiaomi have traded between them. Xiaomi SU7 Ultra: 1526 hp, under two seconds to 100 km/h, launched in China in 2025 at about $73 000, with European sales announced for 2027. Chinese performance figures are manufacturer claims verified at track events rather than by any regulator, and the record claims in this segment change frequently. Lotus Cars is majority-owned by Zhejiang Geely Holding. The point about speed is chapter A's: aerodynamic *power* rises with the cube of speed, so the ratio between 300 and 100 km/h is 27, and no test cycle approaches those speeds.

[^carco2]: Figure 20.9b and every percentage in the section beside it are generated by the `carCo2` step of this edition's data-refresh script and `figures/car_co2.py`. Source: the monitoring database kept under Regulation (EU) 2019/631, in which each member state records one row per new passenger car registered, published by the European Environment Agency and queried here through its Discodata SQL service — the 2025 provisional set (10 827 071 cars carrying a CO<sub>2</sub> figure, twenty-nine reporting countries) and the 2020 final set (11 720 971). Provisional data moves by well under a percent when it is finalised. Three things about the basis, none of them small. MacKay counted *models on sale in the United Kingdom*; this counts *cars registered across the EU, Norway and Iceland*, which is a different quantity in a different place — a registration histogram is a picture of what was chosen and a model histogram of what was offered, and the two differ most exactly where his argument lives. His figures are NEDC and these are WLTP, and WLTP returns a higher number for the same car, so the fall from his 168 to today's 97 is understated in test terms and overstated in every other way listed here. And his vertical axis is a count of models where this one is a share of registrations, so the two histograms cannot be laid on top of each other; his 168 is drawn only to show where the middle of his distribution sat. The three corrections: the grid figure of 213 g CO<sub>2</sub> per kWh for EU generation in 2024 is Ember's; the 21 kWh per 100 km is the real-world fleet measurement used in figure 20.21, and is a consumption at the socket, so charging losses are already in it; and the plug-in hybrid figure of 145 g/km against an official 24, together with the conventional-car figure of 169 against an official 132, are Transport & Environment's reading of the Commission's on-board fuel consumption monitoring data for cars registered in 2024, some 220 000 plug-in hybrids among them. T&E campaigns for an end to the plug-in hybrid category, and the figures are theirs rather than this book's; they are used because the underlying meters are a legal requirement and the comparison is arithmetic, but a reader who distrusts the source should note that the 145 has risen year on year — 135 for 2021–23 registrations, 138 for 2023, 145 for 2024 — while the official figure fell. What the 143 is and is not: it replaces each class average with the corresponding measured one and reweights by the 2025 registration shares; it is not a car-by-car correction, and applying one grid average to twenty-nine countries is crude in both directions, since a Norwegian electric car is near zero and a Polish one is not. The ceilings table applies the same three substitutions to each five-gram bin, scaling the combustion bins by the single ratio 169/132, which is cruder still: it assumes the gap is proportional rather than largest in city driving, where it is in fact largest. Read that column as an order of magnitude and not as a percentage. The one number in the table with no correction in it is the first: MacKay's 80 kWh per 100 km ceiling is cleared by 96% of registrations on the type-approval figures and by 88% on the corrected ones, and neither reading changes the conclusion that his opening step is now behind the market. The ICCT gap is from "From Laboratory to Road: a 2017 update", which gives the divergence between NEDC and real-world consumption as approximately 9% in 2001 and 42% in 2016, across about 1.1 million vehicles from fourteen sources in eight countries. Its published series carries no label for 2006, so the "nearer 190" in the text is this book's interpolation on that curve and should be read as a range of roughly 180 to 195 rather than as a figure.

[^coty]: Figure 20.22b is generated by the `cotyEfficiency` step of this edition's data-refresh script and `figures/coty_efficiency.py`. European Car of the Year winners: Jaguar I-Pace (2019), Kia EV6 (2022), Renault Scénic E-Tech (2024), Renault 5 E-Tech (2025) and Mercedes-Benz CLA (2026); the winners of 2020 and 2021 are omitted as non-electric, and the 2023 Jeep Avenger, which launched as a battery-electric model in Europe, is omitted only because a comparable consumption range was not to hand. Figures are WLTP combined energy consumption across published variants — I-Pace 22.0–25.2, EV6 15.9–20.9, Scénic 13.3–17.8, Renault 5 14.9, CLA 12.2–14.1 — and manufacturers quote these on differing wheel and trim assumptions, so the ranges are not strictly comparable between models. WLTP for battery-electric vehicles is measured from the mains and so includes charging losses, which makes it comparable in principle with MacKay's socket measurement; what it does not include is realistic cabin heating or cooling, high sustained speeds, or cold-soaked batteries. Auxiliary loads of 0.5–1 kW for cabin climate while driving, rising briefly toward 2 kW on a cold start, are consistent with manufacturers' figures and owner measurements; the seasonal spread of roughly 14 kWh/100 km in summer to 26 in December is from fleet telematics reported in the efficiency literature. Treat every figure on the chart as a floor.

[^socket]: Figure 20.21 is generated by the `socketEnergy` step of this edition's data-refresh script and `figures/socket_energy.py`. Values: the e-bike at 0.62 and the Ami at 7.33 are battery capacity divided by claimed range, as set out in the notes above and therefore optimistic; the Hyundai Kona Electric at 13.4 is a WLTP figure and is used as a representative best-in-class rather than as the single most efficient car on sale, since that title changes with each model year; the fleet average of 21 is the real-world measurement across 342 European electric cars; MacKay's 21 for the G-Wiz is his own, measured at the socket over nineteen recharges; and 30 for a large electric pickup is indicative rather than a specific model. The rows are therefore not on a common basis — two derivations, one test cycle, one real-world measurement and one estimate — which is why the figure is drawn as slopes rather than as a ranking, and why the only comparison it makes in the caption is between the two numbers that happen to be measured the same way. MacKay's petrol baseline of 80 kWh per 100 km is chemical energy in the fuel, not electricity at a socket, and is drawn only to give the vertical scale a meaning. This figure replaces MacKay's own rather than sitting beside it. His plots nineteen G-Wiz recharges as a scatter with guide lines at 16, 21 and 33 kWh per 100 km through them; all three of those numbers are stated in his text a few paragraphs below, so the band and the dashed line here are quoted from him and nothing has been read off his axes. What is lost in the merge is the scatter itself — where within the wedge his nineteen points fell — and what is gained is that his measurement and today's cars are on one pair of axes. The wedge is the most useful thing on the chart: one car, one driver and one city produced a factor of 2.1 between the best recharge and the worst, which is the same order as the gap between the best and worst lines drawn here for entirely different vehicles.

[^ebike]: European e-bike unit sales of 5.1 million in 2023 and 5.5 million in 2022, with a small decline in 2024, are the Confederation of the European Bicycle Industry's; comparison with battery-electric car sales uses roughly 2.5 million across the EU, UK and EFTA in 2025, derived from a 20% share of the new-car market, so the "about twice" is an order-of-magnitude statement rather than a precise ratio, and the two series count different geographies. Energy figures: the 0.6 kWh per 100 km is a 500 Wh battery divided by an 80 km light-assist range, which is the optimistic end and the same derivation used for figure 20.23b; 15 Wh/km for an electric mountain bike worked hard and 20 Wh/km for a loaded urban delivery bike are manufacturers' and operators' figures. The spread across those three is more than threefold, and unlike a car's it depends mostly on the rider, so any single quoted figure for an e-bike is close to meaningless without stating the assist level. The family cargo bike row is the same 20 Wh/km divided between a rider and two children, on the derivation and with the caveats set out in the note at figure 20.3 — it does not allow for the extra mass of the passengers, which would raise it, and it credits the rider's own legs with nothing. MacKay's 1.6 kWh per 100 km for unassisted cycling is food energy at the plate rather than electricity at the socket; the two are both kilowatt-hours and are compared here in this book's usual way, but they are not the same commodity and the food figure carries agriculture's own energy cost behind it, which chapter 13 quantifies.

[^smallev]: Citroën Ami specifications are the manufacturer's: 6 kW motor, 5.5 kWh battery, 75 km range, 45 km/h limited, classified as a light quadricycle. The 7.3 kWh per 100 km figure is battery capacity divided by claimed range and is therefore optimistic in the same way every such derivation in this book is — real consumption will be somewhat higher, and the quadricycle class is not subject to the WLTP test that would settle it. Sales of over 75 000 across 18 markets since 2020, a 36% share of the French quadricycle segment and 82% of its electric part in 2023, and the rise in the electric share of that segment from 5% in 2019 to 44% in 2023 are from Citroën and French registration data. The ë-Berlingo Van figure of about 343 km on a 50 kWh battery is a WLTP claim, giving 14.6 kWh per 100 km on the same optimistic basis; MacKay's 25 kWh per 100 km for the Berlingo Electrique 500E is his own note 16, itself an owner's estimate, so the comparison is between two figures of comparable roughness. Electric van rankings vary between compilers and between the UK and continental markets; the ordering given is for 2025 European sales.

[^ev2025]: Sales figures are for 2025 unless stated, from the trade compilations of national registration data; European figures cover the EU, UK and EFTA, and the Chinese figures given are first-half. Rankings from different compilers differ at the margins because of how model variants are grouped — the Volkswagen ID.3 and ID.4 are sometimes counted together and sometimes separately, which moves Volkswagen's position — so these should be read as the shape of each market rather than as a definitive order. The 20% European market share is for battery-electric cars only, excluding plug-in hybrids. Korean domestic sales are small relative to Korean production, which is why that entry is given by manufacturer rather than by market. Test cycles: WLTP in Europe, EPA in the United States, CLTC in China; published comparisons put CLTC range figures roughly 15–30% above WLTP for the same vehicle, and EPA below WLTP, so consumption figures are not comparable across the three without conversion.

[^16]: *Lots of electric vehicles*. A note added in the 2026 revision: the catalogue that follows is a historical document. Of the twenty-odd vehicles named in it, two have a descendant on sale today — the Tesla, whose 2008 Roadster MacKay treats as an exotic prototype, and the Berlingo van — and only one of the ventures built around them prospered. Several of the manufacturers survive, of course; it is the specialist firms and most of the vehicles that did not. Think Global, which made the Th!nk Ox, went bankrupt in 2011. The Loremo was never produced and its company failed in 2010. Aptera went bankrupt in 2011, was revived in 2019, and has still not delivered a production vehicle. Vectrix, which made the scooter, went bankrupt in 2009. Smith Electric Vehicles, which made the minibus, stopped trading. ZAP, which made the Xebra, folded. The G-Wiz was discontinued. The i MiEV, the most conventional car on the list, was built until 2021 and then dropped.
...
Ze-0 A five-seat, five-door car. Maximum speed: 50mph. Range: 50 miles. Weight, including batteries: 1350 kg. Lead acid batteries with capacity of 18 kWh. Motor: 15 kW. <span class="mauve">22.4 kWh per 100 km</span>.
...
Mega City A two-seater car with a maximum continuous power of 4 kW and maximum speed of 40 mph: <span class="mauve">11.5 kWh per 100 km</span>. Weight unladen (including batteries) – 725 kg. The lead batteries have a capacity of 10 kWh.

Xebra Is claimed to have a 40 km range from a 4.75 kWh charge. <span class="mauve">12 kWh per 100 km</span>. Maximum speed 65 km/h. Lead-acid batteries.
...
TREV The Two-Seater Renewable Energy Vehicle (TREV) is a prototype developed by the University of South Australia (figure 20.42). This three-wheeler has a range of 150 km, a top speed of 120 km/h, a mass of 300 kg, and lithium-ion polymer batteries weighing 45 kg. During a real 3000 km trip, the energy consumption was <span class="mauve">6.2 kWh per 100 km</span>. <span class="websitetitle">w3.unisa.edu.au/solarcar/trev/</span>[^deadlinks]
...
[^18]: *Arnold Schwarzenegger ... filling up a hydrogen-powered Hummer*. *Nature* 438, 24 November 2005. I’m not saying that hydrogen will *never* be useful for transportation; but I would hope that such a distinguished journal as *Nature* would address the hydrogen bandwagon with some critical thought, not only euphoria.
...
[^21]: *A lithium-ion battery is 3% lithium*. Source: Fisher et al. (2006).
...
[^24]: *Transrapid magnetic levitation train*. MacKay cited the manufacturer's site at <span class="websitetitle">www.transrapid.de</span>, which no longer resolves — the consortium behind it was wound down after the Shanghai line remained its only commercial deployment and the German Emsland test track closed in 2012 following the 2006 collision there. The page as MacKay would have seen it is at the [Internet Archive](https://web.archive.org/web/20080601000000/http://www.transrapid.de/); [Wikipedia](https://en.wikipedia.org/wiki/Transrapid) carries the project history. *Link updated in the 2026 revision.*
