...
|---|---|
| Battery, motor, propeller — about 90% each way | **1.2 kWh** |
| Synthesised fuel at 60%, burnt at 50% | **3.3 kWh** |

Direct electric drive is **nearly three times better**, and that is before the hull is considered. The Candela section above adds a second factor on top of the first: a foiling hull does not merely convert its energy more efficiently, it *needs less shaft work in the first place*, because lifting the hull clear removes most of the drag. On the Stockholm route those two effects together are what produce a vessel using a fifth of the energy per passenger-kilometre of the diesel it replaced. Where a foil and a battery both work, nothing burning a synthetic hydrocarbon comes close, and nothing in this section should be read as suggesting otherwise.
