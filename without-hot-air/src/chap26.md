...
**The cost claim that travels with it does not survive checking, and the way it fails is instructive.** Sodium cells are quoted at **0.32 to 0.50 yuan per watt-hour**; Chinese lithium-iron-phosphate storage cells averaged **0.365** in April 2026, in a range of 0.335 to 0.395. The widely repeated statement that sodium is about 12% cheaper compares the best sodium quote against the average lithium one. The midpoint of the same sodium range is 12% *dearer*. The ranges overlap rather than separate, and the lithium figure they are measured against had itself risen about a fifth in six months from 0.300.
