...
**How many batteries is that?** A public register of the Great Britain connection queue, rebuilt daily from the transmission and distribution operators' own tables, counts **2803 storage projects totalling 532 GW**, of which **15.5 GW is built and connected** — already more than five times the power of Britain's pumped storage.[^bess] The rest of that number is not a forecast: two-thirds of the capacity, 340 GW across 1019 projects, sits at *scoping*, the least committed stage there is, and the connection dates run out to 2039.

**And it is counted in the wrong unit for this chapter.** The register records megawatts, because that is what a connection agreement is for, and megawatts are what the daily spread pays for. Put the connected 15.5 GW at the two hours the market rewards and it holds about **31 GWh** — Britain's entire battery fleet stores about as much energy as the four pumped storage stations finished by 1984, and about **2.6% of the 1200 GWh** this chapter says the country needs to survive a lull. Build the whole 532 GW queue, every speculative project in it, still at two hours, and it comes to roughly 1070 GWh: **the complete pipeline, fifteen years out, arrives at about the number MacKay wrote down for one week without wind.**
...
### Sweden pays its batteries for standing still, and Britain pays less

*A section added in the 2026 revision.* The claim above — that the market builds power and not energy — can be tested against one country's actual prices, and Sweden is a good test because it has the cheap hours a battery wants. In 2025 **3.3% of price periods in SE3 were negatively priced and 17.5% were under €10 a megawatt-hour**, and the four cheapest hours of the average day cost **€17.8**.

**Buying at €17.8 and selling at €82 still does not pay for the machine.** The four dearest hours of the average SE3 day fetched €82.2. Against that, a four-hour battery has to recover its capital: at BloombergNEF's global turnkey figure of **$110 per kilowatt-hour** it needs about €51 000 per megawatt a year, and at the **€172 per kilowatt-hour** reported for Swedish projects, about €89 000. Per megawatt-hour delivered at a cycle a day, the Swedish case costs €97 all in — **€15 more than the average day earns.** SE4's wider spread turns a €3 profit instead. The median day is worse than the average in both zones, because a handful of extreme days carry the mean.

![What a battery earns by market in Sweden and in Britain against what it costs, in thousands of euros per megawatt of connected power per year. Day-ahead arbitrage returns 72 in SE3, 93 in SE4 and 69 in Britain, against costs of 51 or 89 depending on capex. Sweden's FCR-D returns 57 and its aFRR 103 to 232; Britain's Dynamic Containment returns 36 and its Dynamic Regulation 54 to 121.](/img/without-hot-air/fig-battery-revenue.svg)

<span class="figurenumber">Figure 26.16a.</span> *Added in the 2026 revision.* Everything in euros per megawatt of **connected power** per year, because that is the unit the reserve markets pay in. Britain is on the same axes because it has the same two kinds of market and a longer history of batteries in them.[^sebattery]

**The reserve markets are where the money is, and they are the chapter's argument in its purest form.** Svenska kraftnät's own 2025 monthly reports put FCR-D up at €5.89 to €8.91 per megawatt per hour and **aFRR up in SE3 at €29.40** — four to five times as much. At 40% availability aFRR alone covers the Swedish capital cost; at 90% it covers it nearly three times over. FCR-D at 90% covers 64% of it.

**Now notice what those payments are for.** They are capacity payments: euros per megawatt per hour for *standing ready*, whether or not anything is delivered. A battery earning them barely cycles. Its entire revenue depends on the power it can offer and **none of it on the energy it can store** — so a fifth hour of storage adds nothing whatever to the largest revenue line a Swedish battery has.

**Britain is the same argument with the prices already fallen.** It has both kinds of market, and its day-ahead spread in 2025 was wider than SE3's in euros: the cheapest four hours of the average day cost £52.6 and the dearest £111.1, a spread of €68 against SE3's €64. **The battery still earned less** — €69 000 per megawatt against €72 000 — because Britain has almost no genuinely cheap hours. Only **5.0% of half-hours were under €10** against SE3's 17.5%, so the eighth of the energy lost to the round trip is bought at €61 a megawatt-hour rather than €18. A wide spread at a high price level is worth less than the same spread at a low one, which is the reverse of the intuition that a country with expensive electricity must be a good place to store it.

**And Britain's reserve markets pay about half of Sweden's.** NESO's 2025 auctions cleared Dynamic Containment low — the nearest thing to FCR-D up — at £3.93 per megawatt per hour, **€4.58 against Sweden's €7.22**, and Dynamic Regulation low, the nearest thing to aFRR, at £13.17, **€15.37 against €29.40**. On the chart that is 36 against 57, and 54–121 against 103–232. This figure cannot prove why, but it can state what is true: Britain's response markets are large and long established, NESO cleared an average of 1 215 megawatts of containment in every four-hour block of the year, and their prices have fallen for years as batteries arrived in them. **Sweden's €29.40 is not a fact about batteries. It is a fact about how few of them there are.** A Swedish business case resting on it is a bet that this stays true, and Britain is what happens when it does not.[^gbbattery]

That is a sharper version of what this chapter argued from the British fleet's 1.6 hours. There the market paid for energy within a short window and stopped. Here the market pays for **availability**, and the duration term disappears from the revenue side altogether. The section above supposed a cheaper cell would not change what gets built. This is why: the thing being sold is not the stored energy at all.

### A cheaper cell arrives, and changes nothing about duration

*A section added in the 2026 revision.* The argument above says the market builds power and not energy, and would do so however cheap the cells became. That is a strong claim, and a test of it arrived while this edition was being written.

**Sodium-ion is the first chemistry since lithium with a policy tailwind behind it.** On 17 July 2026 China's finance ministry ended eleven years of exemption: lithium-ion batteries carry a **2% consumption tax from 1 September 2026, rising to 4% from 1 September 2027**, while sodium-ion, solid-state and fuel cells stay exempt until the end of 2028. That is a twenty-eight-month window in which one chemistry is taxed and its substitute is not, in the country that builds most of the world's cells. The hardware is real too: CATL's sodium cell reached **175 Wh/kg**, and the first mass-production sodium-ion passenger car was announced in February 2026 with a 45 kWh pack and over 400 km of range.[^sodium]

**Two cost claims travel with it, and they are not the same claim.** The first is a price: sodium cells at **0.32 to 0.50 yuan per watt-hour**, against Chinese lithium-iron-phosphate storage cells averaging **0.365** in April 2026, in a range of 0.335 to 0.395. Those two ranges overlap rather than separate, and the manufacturers settle it themselves — CATL says it expects to reach *cost parity* with lithium iron phosphate by the end of 2026, which is a statement that the cells are not cheaper now. The second claim is a **levelised** cost about 12% below lithium iron phosphate in storage, and that is a different quantity: lifetime cost divided by lifetime throughput, which a dearer cell can still win if it lasts longer or wastes less.

**The trouble is that the mechanism has closed.** A levelised advantage at an equal or higher cell price has to come from somewhere — more cycles, better round-trip efficiency, or cheaper everything-else. Sodium's headline is 10 000 cycles; lithium-iron-phosphate storage cells are now quoted at 6 000 to 10 000, so the cycle term is parity rather than advantage. Lower energy density means more steel, land and wiring for each stored kilowatt-hour, which pushes the other way. No assumptions are published with the 12%, and levelised cost is the number in this book most sensitive to the assumptions nobody prints.

**Suppose the claim were true anyway.** Suppose sodium cells arrive at a fifth below lithium and stay there. Redo this section's arithmetic: MacKay's 1200 GWh falls from about $84 billion in cells to $67 billion. That is a large saving on a number that was already affordable, and it does not build a single extra hour of duration, because the thing that stops the third hour being built is not the price of the third hour's cells. It is that nothing pays for the energy it stores.

**Which is why this belongs in this chapter rather than in a chapter about batteries.** A cheaper cell makes power cheaper and energy cheaper in exactly the same proportion, so it moves both sides of a ratio that was never the binding constraint. Ambri's cells worked and the company still failed. Sodium's cells work, and may or may not be cheap, and the market they arrive into is the same one.

[^sodium]: China's State Council and Ministry of Finance announced on 17 July 2026 that the consumption-tax exemption for lithium-ion batteries would end, with 2% levied from 1 September 2026 and 4% from 1 September 2027, and that sodium-ion, solid-state and fuel cells would remain exempt from 1 September 2026 to the end of 2028; solar cells are taxed on a similar schedule from April 2027. The 175 Wh/kg figure is CATL's for its Naxtra cell, and the vehicle is the Changan Nevo A06, announced in February 2026 as the first mass-production passenger car with sodium-ion cells, with a 45 kWh pack and a stated range above 400 km — which is a CLTC figure, a cycle that typically runs a quarter to a third above real-world consumption, so 280 to 320 km is the fairer comparison with the European figures used elsewhere in this book. Cell prices are the more uncertain part of this note. The 0.365 yuan/Wh average for 314 Ah lithium-iron-phosphate storage cells in April 2026, its 0.335–0.395 range, and the rise from 0.300 in late October 2025 are trade-press figures with a named basis; the 0.32–0.50 range quoted for sodium is drawn from supplier and industry listings rather than from a price index of the same quality, and should be treated as indicative. **The comparison in the text is this edition's arithmetic on those two ranges, not a published finding.** Cycle-life figures are the commonly quoted ranges rather than a single test protocol, and are the weakest link in the levelised-cost argument in both directions. The $67 billion is $84 billion less a fifth, and inherits every caution attached to the $84 billion. Michael Barnard objected in public to the unsourced economics of the post this note follows, before the note was written; the specific reading of the levelised claim here is this edition's.
...
The word is the problem. **Baseload is a description of a supply, not a requirement of a demand.** It names the constant output of plant that is uneconomic to turn down — coal, and nuclear — and the grids that were built around such plant acquired the habit of describing it as a need. What a demand actually requires is that supply matches it at every moment, which is a question about *flexibility*, not about constancy.

**That said, this chapter is not a comfortable place to make the optimistic case.** Matching a fluctuating supply to a fluctuating demand needs storage, interconnection or demand that moves, and what this chapter records is that Britain built the power and not the energy. Against MacKay's target of 10 GW for five days, it has roughly **10 GW** — almost exactly what he asked for — and about **43 GWh** against the **1200 GWh** the five-day lull needs, which is a thirtieth. The battery fleet's duration is **1.6 to 1.9 hours**, and a Dunkelflaute lasts days. So the correct objection to renewables is not that they cannot provide baseload. It is that the multi-day store this chapter sizes at 1200 GWh has not been built — and seasonal storage, a separate and much larger problem, still less.[^myths]
...
[^sebattery]: Capacity prices are Svenska kraftnät's own monthly reports for 2025: FCR-D up averaged €5.89 per megawatt per hour in March, €8.91 in April, which was the year's high, and €6.86 in October, an average of €7.22, which is what the figure draws; FCR-D down reached €11.38 in April; aFRR up averaged €29.40 in SE3 and €36.60 in SE4 in March. Day-ahead prices are Energy-Charts' series for SE3 and SE4 and Elexon's APXMIDP market index for Britain, all of 2025, from which the cheapest and dearest four hours of each day are taken and then averaged over the year. The Swedish series is hourly until the day-ahead market moved to quarter-hours on 1 October 2025 and quarter-hourly after it, so four hours is taken as a sixth of each day's price points rather than a fixed count. An earlier printing of this section quoted €16 and €85.5 for SE3 from the same source; those do not reproduce, and the figures here, €17.8 and €82.2, are what the stated method gives. Capital costs use BloombergNEF's Energy Storage Systems Cost Survey of December 2025, which gives a global average turnkey cost of $110 per kilowatt-hour for four-hour systems from 596 project submissions, converted at the European Central Bank's 2025 average of $1.13 to the euro; the €172 per kilowatt-hour is a figure reported for Swedish projects rather than a published survey, and it is 70% above the global average, which is plausible for Nordic labour, grid connection and smaller project sizes but is not independently sourced here. **The levelisation is this edition's: 365 cycles a year, fifteen years, a 7% discount rate, 88% round-trip efficiency, 90% depth of discharge and operating costs at 2% of capital a year.** Those assumptions matter more than the price data: at 250 cycles rather than 365 the arbitrage case fails in both zones, and at 500 it succeeds in both. The availability shares for the reserve markets are illustrative rather than observed, since a battery cannot sell its full capacity into every market in every hour. What the figure is for is the comparison between revenue that scales with megawatts and revenue that scales with megawatt-hours, and that comparison does not depend on the particular percentages. Everything on the price side is regenerated by `mill Refresh.scala chapter-26-batteries`, which writes `data-refresh/battery-prices.csv`; the capital costs and Svenska kraftnät's capacity prices stay hand-entered, because neither is published as an open series.

[^bess]: *GB BESS Pipelines*, [bess.gb124.com](https://bess.gb124.com), a public tracker of transmission- and distribution-connected battery storage in Great Britain, which rebuilds itself from the network operators' registers — 1323 transmission and 1480 distribution records at the sync of 8 September 2026, the figures quoted here. Its capacity column is power in megawatts, not energy: the register exists to manage connection agreements, and a connection agreement is a right to inject so many megawatts, silent on how long for. That is why the durations in this section have to be supplied from elsewhere, and the two hours used here is the shape the revenue in figure 26.5b pays for rather than a figure the register reports. Its "built" category, 74 projects and 15.4 GW, plus three separately marked as connected, is the only part of the total that exists; *scoping* projects have no consent, no connection date that binds anyone, and a long history of not being built. The tracker also carries 18 pumped hydro projects totalling 11.1 GW, which is the queue behind Coire Glas described above. Treat the 532 GW as the size of the queue, which is a fact about the queue rather than about Britain's future storage.

[^gbbattery]: British prices are Elexon's APXMIDP market-index series for 2025, treated exactly as the Swedish ones, and NESO's Enduring Auction Capability results for the same calendar year, which straddle two British financial years and are therefore taken from both archives and weighted by cleared volume. The 2025 volume-weighted clearing prices are £3.93 per megawatt per hour for Dynamic Containment low, £6.51 for Dynamic Moderation low, £13.17 for Dynamic Regulation low, £5.46 for positive Quick Reserve and £4.63 for positive Balancing Reserve; the figure draws the first and the third. Sterling is converted at the European Central Bank's 2025 average of £0.857 to the euro. The pairing of products across the two countries is by function and is not exact: Dynamic Containment is a post-fault containment product like FCR-D up, and Dynamic Regulation a continuous pre-fault one like aFRR, but the specifications, the procurement volumes and the penalty regimes all differ, so the comparison is of orders of magnitude rather than like for like.
