...
**That said, this chapter is not a comfortable place to make the optimistic case.** Matching a fluctuating supply to a fluctuating demand needs storage, interconnection or demand that moves, and this chapter records that the world built the power and not the energy: batteries went from 30 GWh to 1200 GWh of installed capacity while the *duration* stayed near two hours, which is the wrong shape for a Dunkelflaute lasting a week. The correct objection to renewables is not that they cannot provide baseload. It is that nobody has yet built the seasonal storage that a high-renewable system needs, and this chapter's arithmetic says why that is hard.[^myths]
