...
Incidentally, when they talk of the CO<sub>2</sub> emissions of a "home," the official exchange rate appears to be 4 tons CO<sub>2</sub> per home per year.
...
"If every household installed just one energy saving light bulb, there would be enough carbon dioxide saved to fill the Royal Albert Hall 1,980 times\!" (An Albert Hall is 100 000 m<sup>3</sup>.)
...
![Scatter of 180 countries, greenhouse-gas emissions per person against GDP per person on a logarithmic axis. Emissions rise with income but spread by a factor of eleven at any given income.](/img/without-hot-air/fig-ghg-vs-gdp.svg)

<span class="figurenumber">Figure I.11.</span> Greenhouse-gas emissions per person against GDP per person, at purchasing-power parity, for 2023. Squares show countries of "high human development," circles those below it — MacKay's convention, using the UNDP's threshold of 0.8 on the Human Development Index. See also figures 30.1, 18.4 and 18.11. This figure and the next replace MacKay's, which were drawn from the UNDP *Human Development Report 2007*.[^ghgscatter]

![The same 180 countries with energy per person on the horizontal axis, and two dashed lines showing what emissions would be if all energy came from coal or from gas.](/img/without-hot-air/fig-ghg-vs-energy.svg)

<span class="figurenumber">Figure I.12.</span> Greenhouse-gas emissions per person against energy per person, for 2023. The dashed lines show what a person's emissions would be if every kWh they used were coal, or were gas, at the intensities of figure I.10 above. The vertical scatter at any given energy use is the same point figure I.11 makes about income: what the energy is made of matters as much as how much of it there is.


## Notes and further reading

[^ghgscatter]: Figures I.11 and I.12 are generated by the `ghgScatter` step in this edition's data-refresh script, from three Our World in Data series joined on country and year: greenhouse-gas emissions per person including land use, the Human Development Index, and the GDP and total-energy-supply series that figure 18.11 uses, so the two chapters quote the same income figures rather than two that nearly agree. The year is 2023, the latest for which all four variables exist — the Human Development Index stops there, while energy and GDP run further. 180 countries carry all four, once Our World in Data's own aggregates — the world, the EU-27 and the income groups, which carry entity codes just as countries do — are excluded, along with one country whose energy figure is recorded as a literal zero. Emissions are in tonnes of CO<sub>2</sub> equivalent per person per year and include land use, which is why a few countries with little energy use still appear high. The threshold of 0.8 on the Human Development Index is the UNDP's own boundary for "high human development" in the 2007 report MacKay drew on, kept here so the squares and circles mean what they meant in his figure. The two dashed lines in figure I.12 are the coal and gas intensities of figure I.10 above, 300 and 190 g CO<sub>2</sub> per kWh of chemical energy, converted at 365 days to tonnes per year.
