...
![Scatter of 186 countries, greenhouse-gas emissions per person against GDP per person on a logarithmic axis. Emissions rise with income but spread by a factor of eleven at any given income.](/img/without-hot-air/fig-ghg-vs-gdp.svg)
...
![The same 186 countries with energy per person on the horizontal axis, and two dashed lines showing what emissions would be if all energy came from coal or from gas.](/img/without-hot-air/fig-ghg-vs-energy.svg)
...
[^ghgscatter]: Figures I.11 and I.12 are generated by the `ghgScatter` step in this edition's data-refresh script, from three Our World in Data series joined on country and year: greenhouse-gas emissions per person including land use, the Human Development Index, and the GDP and total-energy-supply series that figure 18.11 uses, so the two chapters quote the same income figures rather than two that nearly agree. The year is 2023, the latest for which all four variables exist — the Human Development Index stops there, while energy and GDP run further. 186 countries carry all four. Emissions are in tonnes of CO~2~ equivalent per person per year and include land use, which is why a few countries with little energy use still appear high. The threshold of 0.8 on the Human Development Index is the UNDP's own boundary for "high human development" in the 2007 report MacKay drew on, kept here so the squares and circles mean what they meant in his figure. The two dashed lines in figure I.12 are the coal and gas intensities of figure I.10 above, 300 and 190 g CO~2~ per kWh of chemical energy, converted at 365 days to tonnes per year.
